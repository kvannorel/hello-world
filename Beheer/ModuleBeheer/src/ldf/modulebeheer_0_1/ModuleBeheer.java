...
/**
 * Job: ModuleBeheer Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.6.2.20150508_1414
 * @status 
 */
public class ModuleBeheer implements TalendJob {
	...
	private final String jobName = "ModuleBeheer";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ModuleBeheer.this, new Object[] { e,
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ldf.contextreader_2_0.ContextReader childJob_tRunJob_1 = new ldf.contextreader_2_0.ContextReader();
				// pass DataSources
	...
	public void tRunJob_8Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ldf.toevoegen_ldf_overzichten_beheer_0_1.Toevoegen_ldf_overzichten_beheer childJob_tRunJob_8 = new ldf.toevoegen_ldf_overzichten_beheer_0_1.Toevoegen_ldf_overzichten_beheer();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ldf.anl_beh_prf_elem_gegevens_0_1.anl_beh_prf_elem_gegevens childJob_tRunJob_2 = new ldf.anl_beh_prf_elem_gegevens_0_1.anl_beh_prf_elem_gegevens();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ldf.anl_beh_element_group_0_1.anl_beh_element_group childJob_tRunJob_3 = new ldf.anl_beh_element_group_0_1.anl_beh_element_group();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ldf.anl_beh_leverregels_per_lag_0_1.anl_beh_leverregels_per_lag childJob_tRunJob_4 = new ldf.anl_beh_leverregels_per_lag_0_1.anl_beh_leverregels_per_lag();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ldf.anl_beh_afnemerregels_per_lag_0_1.anl_beh_afnemerregels_per_lag childJob_tRunJob_5 = new ldf.anl_beh_afnemerregels_per_lag_0_1.anl_beh_afnemerregels_per_lag();
				// pass DataSources
	...
	public static void main(String[] args) {
		final ModuleBeheer ModuleBeheerClass = new ModuleBeheer();

		int exitCode = ModuleBeheerClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ModuleBeheer.class.getClassLoader()
					.getResourceAsStream(
							"ldf/modulebeheer_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : ModuleBeheer");
		}
...
/************************************************************************************************
 * 59725 characters generated by Talend Open Studio for Data Integration on the
 * August 21, 2018 4:09:03 PM CEST
 ************************************************************************************************/
