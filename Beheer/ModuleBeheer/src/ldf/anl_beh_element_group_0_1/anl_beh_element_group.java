...
package ldf.anl_beh_element_group_0_1;
...
/**
 * Job: anl_beh_element_group Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.6.2.20150508_1414
 * @status 
 */
public class anl_beh_element_group implements TalendJob {
	...
	private final String jobName = "anl_beh_element_group";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					anl_beh_element_group.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(anl_beh_element_group.this, new Object[] {
	...
	public static class OutputStruct implements
		...
		final static byte[] commonByteArrayLock_LDF_anl_beh_element_group = new byte[0];
		static byte[] commonByteArray_LDF_anl_beh_element_group = new byte[0];

		public double groep;

		public double getGroep() {
			return this.groep;
		}

		public String code_groep;

		public String getCode_groep() {
			return this.code_groep;
		}

		public String omschrijving_groep;

		public String getOmschrijving_groep() {
			return this.omschrijving_groep;
		}
		...
		public String omschrijving_element;

		public String getOmschrijving_element() {
			return this.omschrijving_element;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LDF_anl_beh_element_group.length) {
					if (length < 1024
							&& commonByteArray_LDF_anl_beh_element_group.length == 0) {
						commonByteArray_LDF_anl_beh_element_group = new byte[1024];
					} else {
						commonByteArray_LDF_anl_beh_element_group = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LDF_anl_beh_element_group, 0,
						length);
				strReturn = new String(
						commonByteArray_LDF_anl_beh_element_group, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LDF_anl_beh_element_group) {

				try {

					int length = 0;

					this.groep = dis.readDouble();

					this.code_groep = readString(dis);

					this.omschrijving_groep = readString(dis);

					this.entiteitnummer = dis.readDouble();

					this.elementnummer = readString(dis);

					this.omschrijving_element = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				dos.writeDouble(this.groep);

				// String

				writeString(this.code_groep, dos);

				// String

				writeString(this.omschrijving_groep, dos);
				...
				writeString(this.omschrijving_element, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("groep=" + String.valueOf(groep));
			sb.append(",code_groep=" + code_groep);
			sb.append(",omschrijving_groep=" + omschrijving_groep);
			sb.append(",entiteitnummer=" + String.valueOf(entiteitnummer));
			sb.append(",elementnummer=" + elementnummer);
			sb.append(",omschrijving_element=" + omschrijving_element);
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				if (dbschema_tPostgresqlOutput_1 == null
					...
					tableName_tPostgresqlOutput_1 = "anl_beh_element_group";
				} else {
					tableName_tPostgresqlOutput_1 = dbschema_tPostgresqlOutput_1
							+ "\".\"" + "anl_beh_element_group";
				}
				...
				String insert_tPostgresqlOutput_1 = "INSERT INTO \""
						+ tableName_tPostgresqlOutput_1
						+ "\" (\"groep\",\"code_groep\",\"omschrijving_groep\",\"entiteitnummer\",\"elementnummer\",\"omschrijving_element\",\"entiteitnaam\",\"elementnaam\") VALUES (?,?,?,?,?,?,?,?)";
				...
				String dbquery_tJDBCInput_1 = "select\n grp.grpkey as Groep,\n grp.grpcde as Code_groep, \n grp.grpoms as Omschrijving_groep, \n uiv.uivent as Entiteitnummer, \n uiv.uivelmnum as Elementnummer, \n uiv.uivlbl Omschrijving_element \nfrom mbsgrpm00 grp\n join mbsgpsm00 gps on gps.grpkey = grp.grpkey \n join mbsuivm00 uiv on uiv.uivkey = gps.uivkey \norder by grp.grpcde, uiv.uivent, uiv.uivelmnum";
					...
					while (rs_tJDBCInput_1.next()) {
						...
						if (colQtyInRs_tJDBCInput_1 < 1) {
							...
							if (rs_tJDBCInput_1.getObject(1) != null) {
								row1.groep = rs_tJDBCInput_1.getDouble(1);
							} else {
						...
						if (colQtyInRs_tJDBCInput_1 < 2) {
							row1.code_groep = null;
						} else {

							tmpContent_tJDBCInput_1 = rs_tJDBCInput_1
									.getString(2);
							if (tmpContent_tJDBCInput_1 != null) {
								row1.code_groep = tmpContent_tJDBCInput_1;
							} else {
								row1.code_groep = null;
							}
						}
						if (colQtyInRs_tJDBCInput_1 < 3) {
							row1.omschrijving_groep = null;
						} else {

							tmpContent_tJDBCInput_1 = rs_tJDBCInput_1
									.getString(3);
							if (tmpContent_tJDBCInput_1 != null) {
								row1.omschrijving_groep = tmpContent_tJDBCInput_1;
							} else {
								row1.omschrijving_groep = null;
							}
						}
						...
						if (colQtyInRs_tJDBCInput_1 < 6) {
							row1.omschrijving_element = null;
						} else {

							tmpContent_tJDBCInput_1 = rs_tJDBCInput_1
									.getString(6);
							if (tmpContent_tJDBCInput_1 != null) {
								row1.omschrijving_element = tmpContent_tJDBCInput_1;
							} else {
								row1.omschrijving_element = null;
							}
						}
						...
						{ // start of Var scope
							...
							// # Output table : 'Output'
							Output_tmp.groep = row1.groep;
							Output_tmp.code_groep = row1.code_groep;
							Output_tmp.omschrijving_groep = row1.omschrijving_groep;
							Output_tmp.entiteitnummer = row1.entiteitnummer;
							Output_tmp.elementnummer = row1.elementnummer;
							Output_tmp.omschrijving_element = row1.omschrijving_element;
						...
						if (Output != null) {
							...
							pstmt_tPostgresqlOutput_1
									.setDouble(1, Output.groep);

							if (Output.code_groep == null) {
							...
							if (Output.omschrijving_groep == null) {
								pstmt_tPostgresqlOutput_1.setNull(3,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tPostgresqlOutput_1.setString(3,
										Output.omschrijving_groep);
							}

							pstmt_tPostgresqlOutput_1.setDouble(4,
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				context.jobName = "anl_beh_element_group_job";
				context.result = true;
	...
	public void tJava_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				System.out
						.println("anl_beh_element_group_job_________________________________________________");
	...
	public static void main(String[] args) {
		final anl_beh_element_group anl_beh_element_groupClass = new anl_beh_element_group();

		int exitCode = anl_beh_element_groupClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = anl_beh_element_group.class
					.getClassLoader().getResourceAsStream(
							"ldf/anl_beh_element_group_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : anl_beh_element_group");
		}
...
/************************************************************************************************
 * 111197 characters generated by Talend Open Studio for Data Integration on the
