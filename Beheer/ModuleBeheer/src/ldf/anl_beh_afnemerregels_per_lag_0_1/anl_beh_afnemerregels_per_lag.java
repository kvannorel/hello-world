...
package ldf.anl_beh_afnemerregels_per_lag_0_1;
...
/**
 * Job: anl_beh_afnemerregels_per_lag Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.6.2.20150508_1414
 * @status 
 */
public class anl_beh_afnemerregels_per_lag implements TalendJob {
	...
	private final String jobName = "anl_beh_afnemerregels_per_lag";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					anl_beh_afnemerregels_per_lag.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(anl_beh_afnemerregels_per_lag.this,
	...
	public static class OutputStruct implements
		...
		final static byte[] commonByteArrayLock_LDF_anl_beh_afnemerregels_per_lag = new byte[0];
		static byte[] commonByteArray_LDF_anl_beh_afnemerregels_per_lag = new byte[0];
		...
		public String referentieletter;

		public String getReferentieletter() {
			return this.referentieletter;
		}
		...
		public Double afnemerregelnummer;

		public Double getAfnemerregelnummer() {
			return this.afnemerregelnummer;
		}
		...
		public String ind_kennisgeving;

		public String getInd_kennisgeving() {
			return this.ind_kennisgeving;
		}

		public String ind_inf_kennisgeving;

		public String getInd_inf_kennisgeving() {
			return this.ind_inf_kennisgeving;
		}
		...
		public String ind_kennisg_eig_afwijk_waarde;

		public String getInd_kennisg_eig_afwijk_waarde() {
			return this.ind_kennisg_eig_afwijk_waarde;
		}

		public String ind_kennisg_apl_afwijk_waarde;

		public String getInd_kennisg_apl_afwijk_waarde() {
			return this.ind_kennisg_apl_afwijk_waarde;
		}

		public String ind_aanpassen_leverrecord;

		public String getInd_aanpassen_leverrecord() {
			return this.ind_aanpassen_leverrecord;
		}

		public String ind_hist_kennisgeving;

		public String getInd_hist_kennisgeving() {
			return this.ind_hist_kennisgeving;
		}

		public String selectiemethode;

		public String getSelectiemethode() {
			return this.selectiemethode;
		}

		public String actie_inf_verwijderd;

		public String getActie_inf_verwijderd() {
			return this.actie_inf_verwijderd;
		}

		public Double appl_gerelateerde;

		public Double getAppl_gerelateerde() {
			return this.appl_gerelateerde;
		}

		public String code_appl_gerelateerde;

		public String getCode_appl_gerelateerde() {
			return this.code_appl_gerelateerde;
		}

		public String omschrijving_appl_gerelateerde;

		public String getOmschrijving_appl_gerelateerde() {
			return this.omschrijving_appl_gerelateerde;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LDF_anl_beh_afnemerregels_per_lag.length) {
					if (length < 1024
							&& commonByteArray_LDF_anl_beh_afnemerregels_per_lag.length == 0) {
						commonByteArray_LDF_anl_beh_afnemerregels_per_lag = new byte[1024];
					} else {
						commonByteArray_LDF_anl_beh_afnemerregels_per_lag = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_LDF_anl_beh_afnemerregels_per_lag, 0,
						length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LDF_anl_beh_afnemerregels_per_lag) {
				...
				try {
					...
					this.referentieletter = readString(dis);
					...
					length = dis.readByte();
					if (length == -1) {
						this.afnemerregelnummer = null;
					} else {
						this.afnemerregelnummer = dis.readDouble();
					}
					...
					this.ind_kennisgeving = readString(dis);

					this.ind_inf_kennisgeving = readString(dis);
					...
					this.ind_kennisg_eig_afwijk_waarde = readString(dis);

					this.ind_kennisg_apl_afwijk_waarde = readString(dis);

					this.ind_aanpassen_leverrecord = readString(dis);

					this.ind_hist_kennisgeving = readString(dis);

					this.selectiemethode = readString(dis);

					this.actie_inf_verwijderd = readString(dis);

					length = dis.readByte();
					if (length == -1) {
						this.appl_gerelateerde = null;
					} else {
						this.appl_gerelateerde = dis.readDouble();
					}

					this.code_appl_gerelateerde = readString(dis);

					this.omschrijving_appl_gerelateerde = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.referentieletter, dos);
				...
				if (this.afnemerregelnummer == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeDouble(this.afnemerregelnummer);
				}
				...
				writeString(this.ind_kennisgeving, dos);

				// String

				writeString(this.ind_inf_kennisgeving, dos);
				...
				writeString(this.ind_kennisg_eig_afwijk_waarde, dos);

				// String

				writeString(this.ind_kennisg_apl_afwijk_waarde, dos);

				// String

				writeString(this.ind_aanpassen_leverrecord, dos);

				// String

				writeString(this.ind_hist_kennisgeving, dos);

				// String

				writeString(this.selectiemethode, dos);

				// String

				writeString(this.actie_inf_verwijderd, dos);

				// Double

				if (this.appl_gerelateerde == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeDouble(this.appl_gerelateerde);
				}

				// String

				writeString(this.code_appl_gerelateerde, dos);

				// String

				writeString(this.omschrijving_appl_gerelateerde, dos);
		...
		public String toString() {
			...
			sb.append(",referentieletter=" + referentieletter);
			...
			sb.append(",afnemerregelnummer="
					+ String.valueOf(afnemerregelnummer));
			sb.append(",entiteitnummer=" + String.valueOf(entiteitnummer));
			sb.append(",elementnummer=" + elementnummer);
			sb.append(",ind_kennisgeving=" + ind_kennisgeving);
			sb.append(",ind_inf_kennisgeving=" + ind_inf_kennisgeving);
			sb.append(",hierarchie=" + String.valueOf(hierarchie));
			sb.append(",ind_kennisg_eig_afwijk_waarde="
					+ ind_kennisg_eig_afwijk_waarde);
			sb.append(",ind_kennisg_apl_afwijk_waarde="
					+ ind_kennisg_apl_afwijk_waarde);
			sb.append(",ind_aanpassen_leverrecord=" + ind_aanpassen_leverrecord);
			sb.append(",ind_hist_kennisgeving=" + ind_hist_kennisgeving);
			sb.append(",selectiemethode=" + selectiemethode);
			sb.append(",actie_inf_verwijderd=" + actie_inf_verwijderd);
			sb.append(",appl_gerelateerde=" + String.valueOf(appl_gerelateerde));
			sb.append(",code_appl_gerelateerde=" + code_appl_gerelateerde);
			sb.append(",omschrijving_appl_gerelateerde="
					+ omschrijving_appl_gerelateerde);
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				if (dbschema_tPostgresqlOutput_1 == null
					...
					tableName_tPostgresqlOutput_1 = "anl_beh_afnemerregels_per_lag";
				} else {
					tableName_tPostgresqlOutput_1 = dbschema_tPostgresqlOutput_1
							+ "\".\"" + "anl_beh_afnemerregels_per_lag";
				}
				...
				String insert_tPostgresqlOutput_1 = "INSERT INTO \""
						+ tableName_tPostgresqlOutput_1
						+ "\" (\"lag\",\"code_lag\",\"omschrijving_lag\",\"referentieletter\",\"applicatie\",\"code_applicatie\",\"omschrijving_applicatie\",\"organisatie\",\"administratie\",\"afnemerregelnummer\",\"entiteitnummer\",\"elementnummer\",\"ind_kennisgeving\",\"ind_inf_kennisgeving\",\"hierarchie\",\"ind_kennisg_eig_afwijk_waarde\",\"ind_kennisg_apl_afwijk_waarde\",\"ind_aanpassen_leverrecord\",\"ind_hist_kennisgeving\",\"selectiemethode\",\"actie_inf_verwijderd\",\"appl_gerelateerde\",\"code_appl_gerelateerde\",\"omschrijving_appl_gerelateerde\",\"entiteitnaam\",\"elementnaam\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				String dbquery_tJDBCInput_1 = "select\nlag.lagkey as LAG, \n lag.lagcde as Code_LAG,\nlag.lagoms as Omschrijving_LAG,\nlag.lagrefltr as Referentieletter,\napl.aplkey as Applicatie,\napl.aplcde as Code_applicatie, \n apl.aploms as Omschrijving_applicatie, \n apl.aplorg as Organisatie, \n apl.apladm as Administratie, \n afr.afrkey as Afnemerregelnummer,\nafr.afrent as Entiteitnummer,\n afr.afrrelmnum as Elementnummer,\nafr.afrindkng as Ind_kennisgeving, \n afr.afrikgafw as Ind_inf_kennisgeving, \n afr.afrhieafn as Hierarchie, \n afr.afrkngeig as Ind_kennisg_eig_afwijk_waarde,\nafr.afrkngafw as Ind_kennisg_apl_afwijk_waarde,\nafr.afrindlvr as Ind_aanpassen_leverrecord,\nafr.afrindhist as Ind_hist_kennisgeving,\nafr.afrselmth as Selectiemethode,\nafr.afractvrw as Actie_inf_verwijderd, \n apr.aplkey as APPL_gerelateerde,\napr.aplcde as Code_APPL_gerelateerde, \n apr.aploms as Omschrijving_APPL_gerelateerde\nfrom mbslagm00 lag\njoin mbsaplm00 apl on apl.lagkey = lag.lagkey\njoin bdsafrm00 afr on afr.aplkey = apl.aplkey\nleft join mbsaplm00 apr on apr.aplkey = afr.aplafnrel \norder by lag.lagoms, apl.aplcde, afr.afrent, afr.afrrelmnum";
				...
				try {
					...
					while (rs_tJDBCInput_1.next()) {
						...
						if (colQtyInRs_tJDBCInput_1 < 4) {
							row1.referentieletter = null;
						} else {

							tmpContent_tJDBCInput_1 = rs_tJDBCInput_1
									.getString(4);
							if (tmpContent_tJDBCInput_1 != null) {
								row1.referentieletter = tmpContent_tJDBCInput_1;
							} else {
								row1.referentieletter = null;
							}
						}
						...
						if (colQtyInRs_tJDBCInput_1 < 10) {
							row1.afnemerregelnummer = null;
						} else {

							if (rs_tJDBCInput_1.getObject(10) != null) {
								row1.afnemerregelnummer = rs_tJDBCInput_1
										.getDouble(10);
							} else {
								row1.afnemerregelnummer = null;
							}
						...
						if (colQtyInRs_tJDBCInput_1 < 13) {
							row1.ind_kennisgeving = null;
						} else {

							tmpContent_tJDBCInput_1 = rs_tJDBCInput_1
									.getString(13);
							if (tmpContent_tJDBCInput_1 != null) {
								row1.ind_kennisgeving = tmpContent_tJDBCInput_1;
							} else {
								row1.ind_kennisgeving = null;
							}
						}
						if (colQtyInRs_tJDBCInput_1 < 14) {
							row1.ind_inf_kennisgeving = null;
						} else {

							tmpContent_tJDBCInput_1 = rs_tJDBCInput_1
									.getString(14);
							if (tmpContent_tJDBCInput_1 != null) {
								row1.ind_inf_kennisgeving = tmpContent_tJDBCInput_1;
							} else {
								row1.ind_inf_kennisgeving = null;
							}
						}
						if (colQtyInRs_tJDBCInput_1 < 15) {
							...
							if (rs_tJDBCInput_1.getObject(15) != null) {
								row1.hierarchie = rs_tJDBCInput_1.getDouble(15);
							} else {
								row1.hierarchie = null;
							}
						}
						if (colQtyInRs_tJDBCInput_1 < 16) {
							row1.ind_kennisg_eig_afwijk_waarde = null;
						} else {

							tmpContent_tJDBCInput_1 = rs_tJDBCInput_1
									.getString(16);
							if (tmpContent_tJDBCInput_1 != null) {
								row1.ind_kennisg_eig_afwijk_waarde = tmpContent_tJDBCInput_1;
							} else {
								row1.ind_kennisg_eig_afwijk_waarde = null;
							}
						}
						if (colQtyInRs_tJDBCInput_1 < 17) {
							row1.ind_kennisg_apl_afwijk_waarde = null;
						} else {

							tmpContent_tJDBCInput_1 = rs_tJDBCInput_1
									.getString(17);
							if (tmpContent_tJDBCInput_1 != null) {
								row1.ind_kennisg_apl_afwijk_waarde = tmpContent_tJDBCInput_1;
							} else {
								row1.ind_kennisg_apl_afwijk_waarde = null;
							}
						}
						if (colQtyInRs_tJDBCInput_1 < 18) {
							row1.ind_aanpassen_leverrecord = null;
						} else {

							tmpContent_tJDBCInput_1 = rs_tJDBCInput_1
									.getString(18);
							if (tmpContent_tJDBCInput_1 != null) {
								row1.ind_aanpassen_leverrecord = tmpContent_tJDBCInput_1;
							} else {
								row1.ind_aanpassen_leverrecord = null;
							}
						}
						if (colQtyInRs_tJDBCInput_1 < 19) {
							row1.ind_hist_kennisgeving = null;
						} else {

							tmpContent_tJDBCInput_1 = rs_tJDBCInput_1
									.getString(19);
							if (tmpContent_tJDBCInput_1 != null) {
								row1.ind_hist_kennisgeving = tmpContent_tJDBCInput_1;
							} else {
								row1.ind_hist_kennisgeving = null;
							}
						}
						if (colQtyInRs_tJDBCInput_1 < 20) {
							row1.selectiemethode = null;
						} else {

							tmpContent_tJDBCInput_1 = rs_tJDBCInput_1
									.getString(20);
							if (tmpContent_tJDBCInput_1 != null) {
								row1.selectiemethode = tmpContent_tJDBCInput_1;
							} else {
								row1.selectiemethode = null;
							}
						}
						if (colQtyInRs_tJDBCInput_1 < 21) {
							row1.actie_inf_verwijderd = null;
						} else {

							tmpContent_tJDBCInput_1 = rs_tJDBCInput_1
									.getString(21);
							if (tmpContent_tJDBCInput_1 != null) {
								row1.actie_inf_verwijderd = tmpContent_tJDBCInput_1;
							} else {
								row1.actie_inf_verwijderd = null;
							}
						}
						if (colQtyInRs_tJDBCInput_1 < 22) {
							row1.appl_gerelateerde = null;
						} else {

							if (rs_tJDBCInput_1.getObject(22) != null) {
								row1.appl_gerelateerde = rs_tJDBCInput_1
										.getDouble(22);
							} else {
								row1.appl_gerelateerde = null;
							}
						...
						if (colQtyInRs_tJDBCInput_1 < 23) {
							row1.code_appl_gerelateerde = null;
						} else {

							tmpContent_tJDBCInput_1 = rs_tJDBCInput_1
									.getString(23);
							if (tmpContent_tJDBCInput_1 != null) {
								row1.code_appl_gerelateerde = tmpContent_tJDBCInput_1;
							} else {
								row1.code_appl_gerelateerde = null;
							}
						}
						if (colQtyInRs_tJDBCInput_1 < 24) {
							row1.omschrijving_appl_gerelateerde = null;
						} else {

							tmpContent_tJDBCInput_1 = rs_tJDBCInput_1
									.getString(24);
							if (tmpContent_tJDBCInput_1 != null) {
								row1.omschrijving_appl_gerelateerde = tmpContent_tJDBCInput_1;
							} else {
								row1.omschrijving_appl_gerelateerde = null;
							}
						}
						...
						{ // start of Var scope
							...
							Output_tmp.referentieletter = row1.referentieletter;
							...
							Output_tmp.afnemerregelnummer = row1.afnemerregelnummer;
							Output_tmp.entiteitnummer = row1.entiteitnummer;
							Output_tmp.elementnummer = row1.elementnummer;
							Output_tmp.ind_kennisgeving = row1.ind_kennisgeving;
							Output_tmp.ind_inf_kennisgeving = row1.ind_inf_kennisgeving;
							Output_tmp.hierarchie = row1.hierarchie;
							Output_tmp.ind_kennisg_eig_afwijk_waarde = row1.ind_kennisg_eig_afwijk_waarde;
							Output_tmp.ind_kennisg_apl_afwijk_waarde = row1.ind_kennisg_apl_afwijk_waarde;
							Output_tmp.ind_aanpassen_leverrecord = row1.ind_aanpassen_leverrecord;
							Output_tmp.ind_hist_kennisgeving = row1.ind_hist_kennisgeving;
							Output_tmp.selectiemethode = row1.selectiemethode;
							Output_tmp.actie_inf_verwijderd = row1.actie_inf_verwijderd;
							Output_tmp.appl_gerelateerde = row1.appl_gerelateerde;
							Output_tmp.code_appl_gerelateerde = row1.code_appl_gerelateerde;
							Output_tmp.omschrijving_appl_gerelateerde = row1.omschrijving_appl_gerelateerde;
						...
						if (Output != null) {
							...
							if (Output.ind_kennisg_eig_afwijk_waarde == null) {
								pstmt_tPostgresqlOutput_1.setNull(16,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tPostgresqlOutput_1.setString(16,
										Output.ind_kennisg_eig_afwijk_waarde);
							}

							if (Output.ind_kennisg_apl_afwijk_waarde == null) {
								pstmt_tPostgresqlOutput_1.setNull(17,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tPostgresqlOutput_1.setString(17,
										Output.ind_kennisg_apl_afwijk_waarde);
							}

							if (Output.ind_aanpassen_leverrecord == null) {
								pstmt_tPostgresqlOutput_1.setNull(18,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tPostgresqlOutput_1.setString(18,
										Output.ind_aanpassen_leverrecord);
							}

							if (Output.ind_hist_kennisgeving == null) {
								pstmt_tPostgresqlOutput_1.setNull(19,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tPostgresqlOutput_1.setString(19,
										Output.ind_hist_kennisgeving);
							}

							if (Output.selectiemethode == null) {
								pstmt_tPostgresqlOutput_1.setNull(20,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tPostgresqlOutput_1.setString(20,
										Output.selectiemethode);
							}

							if (Output.actie_inf_verwijderd == null) {
								pstmt_tPostgresqlOutput_1.setNull(21,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tPostgresqlOutput_1.setString(21,
										Output.actie_inf_verwijderd);
							}

							if (Output.appl_gerelateerde == null) {
								pstmt_tPostgresqlOutput_1.setNull(22,
										java.sql.Types.DOUBLE);
							} else {
								pstmt_tPostgresqlOutput_1.setDouble(22,
										Output.appl_gerelateerde);
							}

							if (Output.code_appl_gerelateerde == null) {
								pstmt_tPostgresqlOutput_1.setNull(23,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tPostgresqlOutput_1.setString(23,
										Output.code_appl_gerelateerde);
							}

							if (Output.omschrijving_appl_gerelateerde == null) {
								pstmt_tPostgresqlOutput_1.setNull(24,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tPostgresqlOutput_1.setString(24,
										Output.omschrijving_appl_gerelateerde);
							}
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				context.jobName = "anl_beh_afnemerregels_per_lag_job";
				context.result = true;
	...
	public void tJava_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				System.out
						.println("anl_beh_afnemerregels_per_lag_job_________________________________________________");
	...
	public static void main(String[] args) {
		final anl_beh_afnemerregels_per_lag anl_beh_afnemerregels_per_lagClass = new anl_beh_afnemerregels_per_lag();

		int exitCode = anl_beh_afnemerregels_per_lagClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = anl_beh_afnemerregels_per_lag.class
					.getClassLoader().getResourceAsStream(
							"ldf/anl_beh_afnemerregels_per_lag_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : anl_beh_afnemerregels_per_lag");
		}
...
/************************************************************************************************
 * 149755 characters generated by Talend Open Studio for Data Integration on the
