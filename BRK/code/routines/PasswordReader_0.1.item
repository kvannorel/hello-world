...
public class PasswordReader {
	...
	public static String read() {
		//String test = Settings.readFile("../../../../config/staticConfiguration.js");
		String test = Settings.readFile("D:/Makelaarsuite/mks01-nodejs/CirCooNodejs/config/staticConfiguration.js");
		test = test.replace("\n", "").replace("\r", "").replace(" ", "");
