...
package brk.vullen_ldf_overzichten_2_0;
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Vullen_ldf_overzichten.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
java.io.File file_tFileExist_1 = new java.io.File(context.dataFile);
...
System.out.println("Datafile " + context.dataFile + " couldn't be found");
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_1 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_1 {
                    ...
                    paraList_tRunJob_1.add("--context_type " + "dataFile" + "=" + "id_String");
                        }
	...
	Object obj_tRunJob_1 = null;
		...
		brk.logger_2_0.Logger childJob_tRunJob_1 = new brk.logger_2_0.Logger();
	    // pass DataSources
...
public static class ldfovzStruct implements routines.system.IPersistableRow<ldfovzStruct> {
    final static byte[] commonByteArrayLock_BRK_Vullen_ldf_overzichten = new byte[0];
    static byte[] commonByteArray_BRK_Vullen_ldf_overzichten = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BRK_Vullen_ldf_overzichten.length) {
				if(length < 1024 && commonByteArray_BRK_Vullen_ldf_overzichten.length == 0) {
   					commonByteArray_BRK_Vullen_ldf_overzichten = new byte[1024];
				} else {
   					commonByteArray_BRK_Vullen_ldf_overzichten = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BRK_Vullen_ldf_overzichten, 0, length);
			strReturn = new String(commonByteArray_BRK_Vullen_ldf_overzichten, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BRK_Vullen_ldf_overzichten) {
	...
	currentComponent="tPostgresqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						if(execStat) {
							runStat.updateStatOnConnection("ldfovz"+iterateId, 0, 0);
						}
...
if(dbschema_tPostgresqlOutput_1 == null || dbschema_tPostgresqlOutput_1.trim().length() == 0) {
	...
	tableName_tPostgresqlOutput_1 = dbschema_tPostgresqlOutput_1 + "\".\"" + "ldf_overzichten";
}
...
int count_tPostgresqlOutput_1=0;
	    String update_tPostgresqlOutput_1 = "UPDATE \"" + tableName_tPostgresqlOutput_1 + "\" SET \"ldforg\" = ?,\"ldfovz\" = ?,\"ldftbl\" = ?,\"ldfprs\" = ?,\"ldfwgv\" = ?,\"ldfsrt\" = ?,\"ldfvld\" = ?,\"ldfmnu\" = ?,\"ldfsql\" = ?,\"ldfsel\" = ?,\"ldfrow\" = ?,\"ldfmod\" = ?,\"ldflic\" = ?,\"ldfprlg\" = ? WHERE \"id\" = ?";
	    ...
	    resourceMap.put("pstmtUpdate_tPostgresqlOutput_1", pstmtUpdate_tPostgresqlOutput_1);
	    String insert_tPostgresqlOutput_1 = "INSERT INTO \"" + tableName_tPostgresqlOutput_1 + "\" (\"id\",\"ldforg\",\"ldfovz\",\"ldftbl\",\"ldfprs\",\"ldfwgv\",\"ldfsrt\",\"ldfvld\",\"ldfmnu\",\"ldfsql\",\"ldfsel\",\"ldfrow\",\"ldfmod\",\"ldflic\",\"ldfprlg\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	    ...
	    resourceMap.put("pstmtInsert_tPostgresqlOutput_1", pstmtInsert_tPostgresqlOutput_1);
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.dataFile, "ISO-8859-15","|#|","",true,0,0,
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 1;
							...
							row1.ldforg = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 2;
					
							row1.ldfovz = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 3;
					
							row1.ldftbl = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 4;
					
							row1.ldfprs = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 5;
					
							row1.ldfwgv = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 6;
					
							row1.ldfsrt = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 7;
					
							row1.ldfvld = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 8;
					
							row1.ldfmnu = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 9;
					
							row1.ldfsql = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 10;
					
							row1.ldfsel = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 11;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.ldfrow = ParserUtils.parseTo_BigDecimal(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ldfrow", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 12;
							...
							row1.ldfmod = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 13;
					
							row1.ldflic = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 14;
					
							row1.ldfoms = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 15;
					
							row1.ldfprlg = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
if(ldfovz != null) { 
	...
	currentComponent="tPostgresqlOutput_1";
			...
			//ldfovz
				...
				if(execStat){
					runStat.updateStatOnConnection("ldfovz"+iterateId,1, 1);
				}
...
pstmtUpdate_tPostgresqlOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tPostgresqlOutput_1.setString(1, ldfovz.ldforg);
}

                    if(ldfovz.ldfovz == null) {
pstmtUpdate_tPostgresqlOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tPostgresqlOutput_1.setString(2, ldfovz.ldfovz);
}

                    if(ldfovz.ldftbl == null) {
pstmtUpdate_tPostgresqlOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tPostgresqlOutput_1.setString(3, ldfovz.ldftbl);
}

                    if(ldfovz.ldfprs == null) {
pstmtUpdate_tPostgresqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tPostgresqlOutput_1.setString(4, ldfovz.ldfprs);
}

                    if(ldfovz.ldfwgv == null) {
pstmtUpdate_tPostgresqlOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tPostgresqlOutput_1.setString(5, ldfovz.ldfwgv);
}

                    if(ldfovz.ldfsrt == null) {
pstmtUpdate_tPostgresqlOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tPostgresqlOutput_1.setString(6, ldfovz.ldfsrt);
}

                    if(ldfovz.ldfvld == null) {
pstmtUpdate_tPostgresqlOutput_1.setNull(7, java.sql.Types.OTHER);
} else {pstmtUpdate_tPostgresqlOutput_1.setObject(7, ldfovz.ldfvld);
}

                    if(ldfovz.ldfmnu == null) {
pstmtUpdate_tPostgresqlOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tPostgresqlOutput_1.setString(8, ldfovz.ldfmnu);
}

                    if(ldfovz.ldfsql == null) {
pstmtUpdate_tPostgresqlOutput_1.setNull(9, java.sql.Types.OTHER);
} else {pstmtUpdate_tPostgresqlOutput_1.setObject(9, ldfovz.ldfsql);
}

                    if(ldfovz.ldfsel == null) {
pstmtUpdate_tPostgresqlOutput_1.setNull(10, java.sql.Types.OTHER);
} else {pstmtUpdate_tPostgresqlOutput_1.setObject(10, ldfovz.ldfsel);
}

                    pstmtUpdate_tPostgresqlOutput_1.setBigDecimal(11, ldfovz.ldfrow);

                    if(ldfovz.ldfmod == null) {
pstmtUpdate_tPostgresqlOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tPostgresqlOutput_1.setString(12, ldfovz.ldfmod);
}

                    if(ldfovz.ldflic == null) {
pstmtUpdate_tPostgresqlOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tPostgresqlOutput_1.setString(13, ldfovz.ldflic);
}

                    if(ldfovz.ldfprlg == null) {
pstmtUpdate_tPostgresqlOutput_1.setNull(14, java.sql.Types.OTHER);
} else {pstmtUpdate_tPostgresqlOutput_1.setObject(14, ldfovz.ldfprlg);
}


                    pstmtUpdate_tPostgresqlOutput_1.setBigDecimal(15 + count_tPostgresqlOutput_1, ldfovz.id);


            try {
				
                updateFlag_tPostgresqlOutput_1=pstmtUpdate_tPostgresqlOutput_1.executeUpdate();
                updatedCount_tPostgresqlOutput_1 = updatedCount_tPostgresqlOutput_1+updateFlag_tPostgresqlOutput_1;
				
            if(updateFlag_tPostgresqlOutput_1 == 0) {
            	
                        pstmtInsert_tPostgresqlOutput_1.setBigDecimal(1, ldfovz.id);

                        if(ldfovz.ldforg == null) {
pstmtInsert_tPostgresqlOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tPostgresqlOutput_1.setString(2, ldfovz.ldforg);
}

                        if(ldfovz.ldfovz == null) {
pstmtInsert_tPostgresqlOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tPostgresqlOutput_1.setString(3, ldfovz.ldfovz);
}

                        if(ldfovz.ldftbl == null) {
pstmtInsert_tPostgresqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tPostgresqlOutput_1.setString(4, ldfovz.ldftbl);
}

                        if(ldfovz.ldfprs == null) {
pstmtInsert_tPostgresqlOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tPostgresqlOutput_1.setString(5, ldfovz.ldfprs);
}

                        if(ldfovz.ldfwgv == null) {
pstmtInsert_tPostgresqlOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tPostgresqlOutput_1.setString(6, ldfovz.ldfwgv);
}

                        if(ldfovz.ldfsrt == null) {
pstmtInsert_tPostgresqlOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtInsert_tPostgresqlOutput_1.setString(7, ldfovz.ldfsrt);
}

                        if(ldfovz.ldfvld == null) {
pstmtInsert_tPostgresqlOutput_1.setNull(8, java.sql.Types.OTHER);
} else {pstmtInsert_tPostgresqlOutput_1.setObject(8, ldfovz.ldfvld);
}

                        if(ldfovz.ldfmnu == null) {
pstmtInsert_tPostgresqlOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtInsert_tPostgresqlOutput_1.setString(9, ldfovz.ldfmnu);
}

                        if(ldfovz.ldfsql == null) {
pstmtInsert_tPostgresqlOutput_1.setNull(10, java.sql.Types.OTHER);
} else {pstmtInsert_tPostgresqlOutput_1.setObject(10, ldfovz.ldfsql);
}

                        if(ldfovz.ldfsel == null) {
pstmtInsert_tPostgresqlOutput_1.setNull(11, java.sql.Types.OTHER);
} else {pstmtInsert_tPostgresqlOutput_1.setObject(11, ldfovz.ldfsel);
}

                        pstmtInsert_tPostgresqlOutput_1.setBigDecimal(12, ldfovz.ldfrow);

                        if(ldfovz.ldfmod == null) {
pstmtInsert_tPostgresqlOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmtInsert_tPostgresqlOutput_1.setString(13, ldfovz.ldfmod);
}

                        if(ldfovz.ldflic == null) {
pstmtInsert_tPostgresqlOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmtInsert_tPostgresqlOutput_1.setString(14, ldfovz.ldflic);
}

                        if(ldfovz.ldfprlg == null) {
pstmtInsert_tPostgresqlOutput_1.setNull(15, java.sql.Types.OTHER);
} else {pstmtInsert_tPostgresqlOutput_1.setObject(15, ldfovz.ldfprlg);
}
 ...
 */
	...
	nb_line_rejected_tPostgresqlOutput_1=nb_line_rejected_tPostgresqlOutput_1 + rejectedCount_tPostgresqlOutput_1;
        ...
        globalMap.put("tPostgresqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tPostgresqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
	 				runStat.updateStatOnConnection("ldfovz"+iterateId,2, 0);
			 	}
			}
 ...
 */
    ...
    if (resourceMap.get("statementClosed_tPostgresqlOutput_1") == null) {
                ...
                if ((pstmtUpdateToClose_tPostgresqlOutput_1 = (java.sql.PreparedStatement) resourceMap.remove("pstmtUpdate_tPostgresqlOutput_1")) != null) {
                    pstmtUpdateToClose_tPostgresqlOutput_1.close();
                }
                java.sql.PreparedStatement pstmtInsertToClose_tPostgresqlOutput_1 = null;
                if ((pstmtInsertToClose_tPostgresqlOutput_1 = (java.sql.PreparedStatement) resourceMap.remove("pstmtInsert_tPostgresqlOutput_1")) != null) {
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_2 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_2 {
                    ...
                    paraList_tRunJob_2.add("--context_type " + "dataFile" + "=" + "id_String");
                        }
                    public void transmitAllContext() {
                        transmitContext_0();
                    }
	...
	Object obj_tRunJob_2 = null;
		...
		brk.logger_2_0.Logger childJob_tRunJob_2 = new brk.logger_2_0.Logger();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_3 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_3 {
                    ...
                    paraList_tRunJob_3.add("--context_type " + "dataFile" + "=" + "id_String");
                        }
                    public void transmitAllContext() {
                        transmitContext_0();
                    }
	...
	Object obj_tRunJob_3 = null;
		...
		brk.logger_2_0.Logger childJob_tRunJob_3 = new brk.logger_2_0.Logger();
	    // pass DataSources
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Vullen_ldf_overzichten.class.getClassLoader().getResourceAsStream("brk/vullen_ldf_overzichten_2_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Vullen_ldf_overzichten.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        ...
                        context.setContextType("dataFile", "id_String");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Vullen_ldf_overzichten");
        }
...
/************************************************************************************************
 *     122337 characters generated by Talend Open Studio for Data Integration 
