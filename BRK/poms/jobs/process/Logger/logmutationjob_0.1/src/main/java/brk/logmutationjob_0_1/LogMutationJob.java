...
package brk.logmutationjob_0_1;
...
/**
 * Job: LogMutationJob Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status 
 */
public class LogMutationJob implements TalendJob {
...
public Boolean getResult(){
	...
	private final String jobName = "LogMutationJob";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				LogMutationJob.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LogMutationJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
context.result = true;
context.jobName = "process_mutation_job";
 ...
 */
    ...
    public static void main(String[] args){
        final LogMutationJob LogMutationJobClass = new LogMutationJob();

        int exitCode = LogMutationJobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LogMutationJob.class.getClassLoader().getResourceAsStream("brk/logmutationjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LogMutationJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LogMutationJob");
        }
...
/************************************************************************************************
 *     33802 characters generated by Talend Open Studio for Data Integration 
