...
package brk.fill_original_objects_0_1;
...
/**
 * Job: fill_original_objects Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status 
 */
public class fill_original_objects implements TalendJob {
...
public Boolean getResult(){
	...
	private final String jobName = "fill_original_objects";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				fill_original_objects.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(fill_original_objects.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tPostgresPlusCommit_1_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
				
				end_Hash.put(errorComponent, System.currentTimeMillis());
				
				status = "failure";
				
					tPostgresPlusCommit_1_onSubJobError(exception, errorComponent, globalMap);
			}
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tPostgresPlusCommit_1_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public void tPostgresPlusConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	java.sql.Connection conn_tPostgresPlusConnection_1 = null;
					...
					String driverClass_tPostgresPlusConnection_1 = "org.postgresql.Driver";
			java.lang.Class jdbcclazz_tPostgresPlusConnection_1 = java.lang.Class.forName(driverClass_tPostgresPlusConnection_1);
		
				conn_tPostgresPlusConnection_1 = java.sql.DriverManager.getConnection(url_tPostgresPlusConnection_1,dbUser_tPostgresPlusConnection_1,dbPwd_tPostgresPlusConnection_1);

		globalMap.put("conn_tPostgresPlusConnection_1", conn_tPostgresPlusConnection_1);
...
query_tPostgresPlusRow_1 = "UPDATE brk_terinschrijvingaangebodenstuk tiastuk\nSET original_amount_objects = (\n	SELECT original_amount_objects\n	FR"
+"OM brk_terinschrijvingaangebodenstuk_h stukhistory\n	WHERE stukhistory.terinschrijvingaangebodenstukid = tiastuk.terinsc"
+"hrijvingaangebodenstukid)\nWHERE original_amount_objects IS NULL;\n\nUPDATE brk_terinschrijvingaangebodenstuk tiastuk\nS"
+"ET original_percelen = (\n	SELECT original_percelen\n	FROM brk_terinschrijvingaangebodenstuk_h stukhistory\n	WHERE stukh"
+"istory.terinschrijvingaangebodenstukid = tiastuk.terinschrijvingaangebodenstukid)\nWHERE original_percelen IS NULL;\n\nU"
+"PDATE brk_terinschrijvingaangebodenstuk stuk SET original_amount_objects = (\n	SELECT count(stukref.terinschrijvingaange"
+"bodenstukidlokaalid)\n	FROM brk_terinschrijvingaangebodenstuk AS stukref\n	WHERE stukref.terinschrijvingaangebodenstukid"
+"lokaalid = stuk.terinschrijvingaangebodenstukidlokaalid\n	GROUP BY terinschrijvingaangebodenstukidlokaalid)\nWHERE origi"
+"nal_amount_objects IS NULL;\n\nDROP TABLE IF EXISTS brk_tia_perceel;\nSELECT relstuk.terinschrijvingaangebodenstukidloka"
+"alid,\n	string_agg(distinct concat_ws(' ', perceel.kdoperceelkadaanduidanaamadgemwaarde, perceel.kdoperceelkadaanduidsec"
+"tie, perceel.kdoperceelkadaanduidanaamadgemperceelnummer, perceel.kdoperceelkadaanduidanaamadgemappartsrechtvolgnummer),"
+" ', ') as original_percelen\nINTO brk_tia_perceel\n	FROM  brk_terinschrijvingaangebodenstuk relstuk\n	LEFT JOIN brk_stuk"
+"delen stukdeel ON stukdeel.id = relstuk.terinschrijvingaangebodenstukid\n	LEFT JOIN brk_tennaamstelling_stukdeel tennaam"
+"stelling_stukdeel ON tennaamstelling_stukdeel.href = stukdeel.stukdeelid\n	LEFT JOIN brk_tennaamstelling tennaamstelling"
+" ON tennaamstelling.tennaamstellingid = tennaamstelling_stukdeel.tennaamstellingid\n	LEFT JOIN brk_zakelijkrecht zakelij"
+"krecht ON zakelijkrecht.kdozakelijkrechtid = tennaamstelling.tennaamstellingvanzakelijkrechthref\n	LEFT JOIN brk_zakelij"
+"krecht_belastmet belastmet ON belastmet.href = zakelijkrecht.kdozakelijkrechtid\n	LEFT JOIN brk_zakelijkrecht mainzak ON"
+" mainzak.kdozakelijkrechtid = belastmet.zakelijkrechtid\n	LEFT JOIN brk_kdoperceel perceel ON perceel.kdoperceelid = zak"
+"elijkrecht.kdozakelijkrechtrustophref OR perceel.kdoperceelid = mainzak.kdozakelijkrechtrustophref\n	GROUP BY relstuk.te"
+"rinschrijvingaangebodenstukidlokaalid;\n\nUPDATE brk_terinschrijvingaangebodenstuk stuk SET original_percelen = (\n	SELE"
+"CT original_percelen \n	FROM brk_tia_perceel relstuk\n    WHERE relstuk.terinschrijvingaangebodenstukidlokaalid = stuk.t"
+"erinschrijvingaangebodenstukidlokaalid)\nWHERE original_percelen IS NULL;\n\nDROP TABLE brk_tia_perceel;";
...
context.result = true;
context.jobName = "brk_terinschrijvingaangebodenstuk_update_job";
 ...
 */
							...
							tPostgresPlusCommit_1Process(globalMap); 
...
public void tPostgresPlusCommit_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	globalMap.put("tPostgresPlusCommit_1_SUBPROCESS_STATE", 0);
 ...
 final boolean execStat = this.execStat;
	...
	/**
	 * [tPostgresPlusCommit_1 begin ] start
	 */
		...
		ok_Hash.put("tPostgresPlusCommit_1", false);
		start_Hash.put("tPostgresPlusCommit_1", System.currentTimeMillis());
		
	
	currentComponent="tPostgresPlusCommit_1";

	
		int tos_count_tPostgresPlusCommit_1 = 0;
...
/**
 * [tPostgresPlusCommit_1 begin ] stop
 */
	
	/**
	 * [tPostgresPlusCommit_1 main ] start
	 */
	...
	java.sql.Connection conn_tPostgresPlusCommit_1 = (java.sql.Connection)globalMap.get("conn_tPostgresPlusConnection_1");
	if(conn_tPostgresPlusCommit_1 != null && !conn_tPostgresPlusCommit_1.isClosed())
	{
	
			
			conn_tPostgresPlusCommit_1.commit();
	...
	tos_count_tPostgresPlusCommit_1++;

/**
 * [tPostgresPlusCommit_1 main ] stop
 */
	
	/**
	 * [tPostgresPlusCommit_1 process_data_begin ] start
	 */
...
/**
 * [tPostgresPlusCommit_1 process_data_begin ] stop
 */
	
	/**
	 * [tPostgresPlusCommit_1 process_data_end ] start
	 */
...
/**
 * [tPostgresPlusCommit_1 process_data_end ] stop
 */
	
	/**
	 * [tPostgresPlusCommit_1 end ] start
	 */
...
ok_Hash.put("tPostgresPlusCommit_1", true);
end_Hash.put("tPostgresPlusCommit_1", System.currentTimeMillis());




/**
 * [tPostgresPlusCommit_1 end ] stop
 */
				}//end the resume
	...
	/**
	 * [tPostgresPlusCommit_1 finally ] start
	 */
...
/**
 * [tPostgresPlusCommit_1 finally ] stop
 */
				}catch(java.lang.Exception e){	
					//ignore
				}catch(java.lang.Error error){
		...
		globalMap.put("tPostgresPlusCommit_1_SUBPROCESS_STATE", 1);
	}
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","Begonnen met originele objecten vullen (23/23)","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 3, "Begonnen met originele objecten vullen (23/23)", 42);
	tLogCatcher_1Process(globalMap);
	globalMap.put("tWarn_1_WARN_MESSAGES", "Begonnen met originele objecten vullen (23/23)"); 
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_BRK_fill_original_objects = new byte[0];
    static byte[] commonByteArray_BRK_fill_original_objects = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BRK_fill_original_objects.length) {
				if(length < 1024 && commonByteArray_BRK_fill_original_objects.length == 0) {
   					commonByteArray_BRK_fill_original_objects = new byte[1024];
				} else {
   					commonByteArray_BRK_fill_original_objects = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BRK_fill_original_objects, 0, length);
			strReturn = new String(commonByteArray_BRK_fill_original_objects, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BRK_fill_original_objects) {
 ...
 */
    ...
    public static void main(String[] args){
        final fill_original_objects fill_original_objectsClass = new fill_original_objects();

        int exitCode = fill_original_objectsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = fill_original_objects.class.getClassLoader().getResourceAsStream("brk/fill_original_objects_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = fill_original_objects.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : fill_original_objects");
        }
...
/************************************************************************************************
 *     83200 characters generated by Talend Open Studio for Data Integration 
