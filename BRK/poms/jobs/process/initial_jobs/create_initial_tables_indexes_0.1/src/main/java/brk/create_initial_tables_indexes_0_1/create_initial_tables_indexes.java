...
package brk.create_initial_tables_indexes_0_1;
...
/**
 * Job: create_initial_tables_indexes Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status 
 */
public class create_initial_tables_indexes implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "create_initial_tables_indexes";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				create_initial_tables_indexes.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(create_initial_tables_indexes.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","Begonnen met indexen creeren op brk tabellen (15/23)","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 3, "Begonnen met indexen creeren op brk tabellen (15/23)", 42);
	tLogCatcher_1Process(globalMap);
	globalMap.put("tWarn_1_WARN_MESSAGES", "Begonnen met indexen creeren op brk tabellen (15/23)"); 
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_BRK_create_initial_tables_indexes = new byte[0];
    static byte[] commonByteArray_BRK_create_initial_tables_indexes = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BRK_create_initial_tables_indexes.length) {
				if(length < 1024 && commonByteArray_BRK_create_initial_tables_indexes.length == 0) {
   					commonByteArray_BRK_create_initial_tables_indexes = new byte[1024];
				} else {
   					commonByteArray_BRK_create_initial_tables_indexes = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BRK_create_initial_tables_indexes, 0, length);
			strReturn = new String(commonByteArray_BRK_create_initial_tables_indexes, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BRK_create_initial_tables_indexes) {
...
query_tPostgresPlusRow_1 = "CREATE INDEX brk_appartementsrecht1\n  ON brk_appartementsrecht\n  USING btree\n  (appartementsrechtid);\n\nCREATE INDE"
+"X brk_ingezetene1\n  ON brk_ingezetene\n  USING btree\n  (ingezeteneid);\n\nCREATE INDEX brk_kadasterstuk1\n  ON brk_kad"
+"asterstuk\n  USING btree\n  (kadasterstukid);\n\nCREATE INDEX brk_kadasterstuk2\n  ON brk_kadasterstuk\n  USING btree\n "
+" (kadasterstuklidokaalid);\n  \nCREATE INDEX brk_kadnatprs1\n  ON brk_kadnatprs\n  USING btree\n  (kadnatprsid);\n  \nCR"
+"EATE INDEX brk_kadnnp1\n  ON brk_kadnnp\n  USING btree\n  (kadnnpid);\n\nCREATE INDEX brk_kdoperceel1\n  ON brk_kdoperce"
+"el\n  USING btree\n  (kdoperceelid);\n\nCREATE INDEX brk_kdoperceel_locatiekadobj1\n  ON brk_kdoperceel_locatiekadobj\n "
+" USING btree\n  (perceelid);\n\nCREATE INDEX brk_kdoperceel_locatiekadobj2\n  ON brk_kdoperceel_locatiekadobj\n  USING b"
+"tree\n  (kadbinpostcode);\n\nCREATE INDEX brk_kdoperceel_locatiekadobj3\n  ON brk_kdoperceel_locatiekadobj\n  USING btre"
+"e\n  (vbopostcode);\n\nCREATE INDEX brk_kdoperceel_locatiekadobj4\n  ON brk_kdoperceel_locatiekadobj\n  USING btree\n  ("
+"vbonevenpostcode);\n\nCREATE INDEX brk_kdoperceel_locatiekadobj5\n  ON brk_kdoperceel_locatiekadobj\n  USING btree\n  (s"
+"tandplaatspostcode);\n\nCREATE INDEX brk_kdoperceel_locatiekadobj6\n  ON brk_kdoperceel_locatiekadobj\n  USING btree\n  "
+"(standplaatsnevenpostcode);\n\nCREATE INDEX brk_kdoperceel_locatiekadobj7\n  ON brk_kdoperceel_locatiekadobj\n  USING bt"
+"ree\n  (ligplaatspostcode);\n\nCREATE INDEX brk_kdoperceel_locatiekadobj8\n  ON brk_kdoperceel_locatiekadobj\n  USING bt"
+"ree\n  (ligplaatsnevenpostcode);\n  \nCREATE INDEX brk_nietingezetene1\n  ON brk_nietingezetene\n  USING btree\n  (nieti"
+"ngezeteneid, nietingezetenebsn);\n  \n  \nCREATE INDEX brk_rechtpersoon1\n  ON brk_rechtpersoon\n  USING btree\n  (recht"
+"persoonid);\n\nCREATE INDEX brk_stukdelen1\n  ON brk_stukdelen\n  USING btree\n  (id);\n\nCREATE INDEX brk_stukdelen2\n "
+" ON brk_stukdelen\n  USING btree\n  (stukdeelid);\n  \nCREATE INDEX brk_tennaamstelling1\n  ON brk_tennaamstelling\n  US"
+"ING btree\n  (tennaamstellingvanzakelijkrechthref);\n  \nCREATE INDEX brk_tennaamstelling2\n  ON brk_tennaamstelling\n  "
+"USING btree\n  (tennaamstellingvanpersoonrechtsprshref);\n\n\nCREATE INDEX brk_tennaamstelling3\n  ON brk_tennaamstellin"
+"g\n  USING btree\n  (tennaamstellingvanpersoonkadnnphref);\n  \nCREATE INDEX brk_tennaamstelling4\n  ON brk_tennaamstell"
+"ing\n  USING btree\n  (tennaamstellingvanpersooningezetenehref);\n  \nCREATE INDEX brk_tennaamstelling5\n  ON brk_tennaa"
+"mstelling\n  USING btree\n  (tennaamstellingvanpersoonnietingezetenehref);\n  \nCREATE INDEX brk_tennaamstelling6\n  ON "
+"brk_tennaamstelling\n  USING btree\n  (tennaamstellingvanpersoonkadnatprshref);\n  \nCREATE INDEX brk_tennaamstelling7\n"
+"  ON brk_tennaamstelling\n  USING btree\n  (tennaamstellingid);\n\nCREATE INDEX brk_tennaamstelling_prs1\n  ON brk_tenna"
+"amstelling_prs\n  USING btree\n  (tennaamstellingid, href);\n\nCREATE INDEX brk_tennaamstelling_stukdeel1\n  ON brk_tenn"
+"aamstelling_stukdeel\n  USING btree\n  (href, tennaamstellingid);\n\nCREATE INDEX brk_terinschrijvingaangebodenstuk1\n  "
+"ON brk_terinschrijvingaangebodenstuk\n  USING btree\n  (terinschrijvingaangebodenstukid);\n\nCREATE INDEX brk_terinschri"
+"jvingaangebodenstuk2\n  ON brk_terinschrijvingaangebodenstuk\n  USING btree\n  (terinschrijvingaangebodenstukidlokaalid)"
+";\n\nCREATE INDEX brk_zakelijkrecht1\n  ON brk_zakelijkrecht\n  USING btree\n  (kdozakelijkrechtrustophref);\n  \nCREATE"
+" INDEX brk_zakelijkrecht2\n  ON brk_zakelijkrecht\n  USING btree\n  (kdozakelijkrechtid);\n  \nCREATE INDEX brk_zakelijk"
+"recht_belastmet1\n  ON brk_zakelijkrecht_belastmet\n  USING btree\n  (zakelijkrechtid);\n  \nCREATE INDEX brk_zakelijkre"
+"cht_belastmet2\n  ON brk_zakelijkrecht_belastmet\n  USING btree\n  (href);";
 ...
 */
    ...
    public static void main(String[] args){
        final create_initial_tables_indexes create_initial_tables_indexesClass = new create_initial_tables_indexes();

        int exitCode = create_initial_tables_indexesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = create_initial_tables_indexes.class.getClassLoader().getResourceAsStream("brk/create_initial_tables_indexes_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = create_initial_tables_indexes.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : create_initial_tables_indexes");
        }
...
/************************************************************************************************
 *     63566 characters generated by Talend Open Studio for Data Integration 
