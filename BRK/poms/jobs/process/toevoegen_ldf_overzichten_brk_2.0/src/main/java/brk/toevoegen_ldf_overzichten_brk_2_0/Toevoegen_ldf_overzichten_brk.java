...
package brk.toevoegen_ldf_overzichten_brk_2_0;
...
/**
 * Job: Toevoegen_ldf_overzichten_brk Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status 
 */
public class Toevoegen_ldf_overzichten_brk implements TalendJob {
...
public String getConfDir(){
	...
	private final String jobName = "Toevoegen_ldf_overzichten_brk";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Toevoegen_ldf_overzichten_brk.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Toevoegen_ldf_overzichten_brk.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
context.dataFile = context.confDir + "ovz0000000301.def";
context.jobName = "ldf_overzichten_brk_perceel_algemeen";
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		brk.vullen_ldf_overzichten_2_0.Vullen_ldf_overzichten childJob_tRunJob_1 = new brk.vullen_ldf_overzichten_2_0.Vullen_ldf_overzichten();
	    // pass DataSources
...
context.dataFile = context.confDir + "ovz0000000302.def";
context.jobName = "ldf_overzichten_brk_perceel_zakelijkrecht";
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		brk.vullen_ldf_overzichten_2_0.Vullen_ldf_overzichten childJob_tRunJob_2 = new brk.vullen_ldf_overzichten_2_0.Vullen_ldf_overzichten();
	    // pass DataSources
...
context.dataFile = context.confDir + "ovz0000000303.def";
context.jobName = "ldf_overzichten_brk_perceel_koopsomjaar";
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		brk.vullen_ldf_overzichten_2_0.Vullen_ldf_overzichten childJob_tRunJob_3 = new brk.vullen_ldf_overzichten_2_0.Vullen_ldf_overzichten();
	    // pass DataSources
...
context.dataFile = context.confDir + "ovz0000000304.def";
context.jobName = "ldf_overzichten_brk_perceel_persoon";
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_4 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_4 {
                    ...
                    paraList_tRunJob_4.add("--context_type " + "dataFile" + "=" + "id_String");
	...
	Object obj_tRunJob_4 = null;
		...
		brk.vullen_ldf_overzichten_2_0.Vullen_ldf_overzichten childJob_tRunJob_4 = new brk.vullen_ldf_overzichten_2_0.Vullen_ldf_overzichten();
	    // pass DataSources
...
context.dataFile = context.confDir + "ovz0000000305.def";
context.jobName = "ldf_overzichten_brk_perceel_nnp";
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_5 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_5 {
                    ...
                    paraList_tRunJob_5.add("--context_type " + "dataFile" + "=" + "id_String");
	...
	Object obj_tRunJob_5 = null;
		...
		brk.vullen_ldf_overzichten_2_0.Vullen_ldf_overzichten childJob_tRunJob_5 = new brk.vullen_ldf_overzichten_2_0.Vullen_ldf_overzichten();
	    // pass DataSources
...
context.dataFile = context.confDir + "ovz0000000306.def";
context.jobName = "ldf_overzichten_brk_perceel_persoon_ba";
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_6 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_6 {
                    ...
                    paraList_tRunJob_6.add("--context_type " + "dataFile" + "=" + "id_String");
	...
	Object obj_tRunJob_6 = null;
		...
		brk.vullen_ldf_overzichten_2_0.Vullen_ldf_overzichten childJob_tRunJob_6 = new brk.vullen_ldf_overzichten_2_0.Vullen_ldf_overzichten();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final Toevoegen_ldf_overzichten_brk Toevoegen_ldf_overzichten_brkClass = new Toevoegen_ldf_overzichten_brk();

        int exitCode = Toevoegen_ldf_overzichten_brkClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Toevoegen_ldf_overzichten_brk.class.getClassLoader().getResourceAsStream("brk/toevoegen_ldf_overzichten_brk_2_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Toevoegen_ldf_overzichten_brk.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("dataFile")) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Toevoegen_ldf_overzichten_brk");
        }
...
/************************************************************************************************
 *     95521 characters generated by Talend Open Studio for Data Integration 
