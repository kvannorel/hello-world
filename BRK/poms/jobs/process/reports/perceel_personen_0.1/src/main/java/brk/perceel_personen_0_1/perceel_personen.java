...
package brk.perceel_personen_0_1;
...
/**
 * Job: perceel_personen Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status 
 */
public class perceel_personen implements TalendJob {
...
public Boolean getResult(){
	...
	private final String jobName = "perceel_personen";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				perceel_personen.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(perceel_personen.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","Begonnen met rapport personen (20/23)","", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 3, "Begonnen met rapport personen (20/23)", 42);
	tLogCatcher_1Process(globalMap);
	globalMap.put("tWarn_1_WARN_MESSAGES", "Begonnen met rapport personen (20/23)"); 
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_BRK_perceel_personen = new byte[0];
    static byte[] commonByteArray_BRK_perceel_personen = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BRK_perceel_personen.length) {
				if(length < 1024 && commonByteArray_BRK_perceel_personen.length == 0) {
   					commonByteArray_BRK_perceel_personen = new byte[1024];
				} else {
   					commonByteArray_BRK_perceel_personen = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BRK_perceel_personen, 0, length);
			strReturn = new String(commonByteArray_BRK_perceel_personen, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BRK_perceel_personen) {
...
query_tPostgresPlusRow_1 = "DROP TABLE IF EXISTS brk_perceel_persoon;\nCREATE TABLE " + Settings.get("SCHEMA_NAME_LOOKUP", "ldf") + ".brk_perceel_persoon AS\nSELECT\n      ingezetene.ingezeteneid AS link_id,\n      ingezetene.ingezetenebsn AS bsn,\n   "
+"   upper(NULLIF(concat_ws(' ', ingezetene.ingezetenenaamvoornamen, ingezetene.ingezetenenaamvoorvoegselsgeslachtsnaam, i"
+"ngezetene.ingezetenenaamgeslachtsnaam), '')) AS naam,\n      ingezetene.ingezetenegeboortedatum AS geboortedatum,\n     "
+" COALESCE(NULLIF(CONCAT_WS(' ', adr.adresbinnenland1_v, adr.adresbinnenland2_v, adr.adresbinnenland3_v),''),\n          "
+"  NULLIF(CONCAT_WS(' ', adr.adresbuitenland1_v, adr.adresbuitenland2_v, adr.adresbuitenland3_v),''),\n            NULLIF"
+"(CONCAT_WS(' ', adr.adresbinnenland1_i, adr.adresbinnenland2_i, adr.adresbinnenland3_i),''),\n            NULLIF(CONCAT_"
+"WS(' ', adr.adresbuitenland1_i, adr.adresbuitenland2_i, adr.adresbuitenland3_i),''),\n            NULLIF(UPPER(CONCAT_WS"
+"(' ', ingezetene.ingezetenewoonlockadbinadroprnaam, ingezetene.ingezetenewoonlockadbinadrhuisnum, ingezetene.ingezetenew"
+"oonlockadbinadrhuisnummertoevoeg, \n            ingezetene.ingezetenewoonlockadbinadrpostcode,ingezetene.ingezetenewoonl"
+"ockadbinadrwoonplaatsnaam)),'')) AS adres,\n      NULLIF(concat_ws(' ', perceel.kdoperceelkadaanduidanaamadgemwaarde, pe"
+"rceel.kdoperceelkadaanduidsectie, perceel.kdoperceelkadaanduidanaamadgemperceelnummer, perceel.kdoperceelkadaanduidanaam"
+"adgemappartsrechtvolgnummer), '') AS perceel,\n      perceel.kdoperceelkadgroottewaarde AS grootte,\n      perceel.kdope"
+"rceelsoortgroottewaarde AS groottesoort,\n      geom.geom AS geo\nFROM brk_ingezetene ingezetene\nLEFT JOIN anl_persoon "
+"adr ON trim(to_char(adr.burgerservicenummer, '999999999')) = ingezetene.ingezetenebsn\nLEFT JOIN brk_tennaamstelling ten"
+"naamstelling ON ingezetene.ingezeteneid = tennaamstelling.tennaamstellingvanpersooningezetenehref\nLEFT JOIN brk_zakelij"
+"krecht zakelijkrecht ON zakelijkrecht.kdozakelijkrechtid = tennaamstelling.tennaamstellingvanzakelijkrechthref\nLEFT JOI"
+"N brk_zakelijkrecht_belastmet belastmet ON belastmet.href = zakelijkrecht.kdozakelijkrechtid\nLEFT JOIN brk_zakelijkrech"
+"t hoofdrecht ON hoofdrecht.kdozakelijkrechtid = belastmet.zakelijkrechtid\nLEFT JOIN brk_kdoperceel perceel ON perceel.k"
+"doperceelid = zakelijkrecht.kdozakelijkrechtrustophref OR perceel.kdoperceelid = hoofdrecht.kdozakelijkrechtrustophref\n"
+"LEFT JOIN brk_geometry geom ON geom.id = perceel.kdoperceelid;\n\nINSERT INTO brk_perceel_persoon SELECT \n      nieting"
+"ezetene.nietingezeteneid AS link_id,\n      nietingezetene.nietingezetenebsn AS bsn,\n      upper(NULLIF(concat_ws(' ', "
+"nietingezetene.nietingezetenenaamvoornamen, nietingezetene.nietingezetenenaamvoorvoegselsgeslachtsnaam, nietingezetene.n"
+"ietingezetenenaamgeslachtsnaam), '')) AS naam,\n      nietingezetene.nietingezetenegeboortedatum AS geboortedatum,\n    "
+"  COALESCE(NULLIF(CONCAT_WS(' ', adr.adresbinnenland1_v, adr.adresbinnenland2_v, adr.adresbinnenland3_v),''),\n         "
+"   NULLIF(CONCAT_WS(' ', adr.adresbuitenland1_v, adr.adresbuitenland2_v, adr.adresbuitenland3_v),''),\n            NULLI"
+"F(CONCAT_WS(' ', adr.adresbinnenland1_i, adr.adresbinnenland2_i, adr.adresbinnenland3_i),''),\n            NULLIF(CONCAT"
+"_WS(' ', adr.adresbuitenland1_i, adr.adresbuitenland2_i, adr.adresbuitenland3_i),''),\n            NULLIF(UPPER(CONCAT_W"
+"S(', ',nietingezetene.nietingezetenewoonlockadbuitadres, nietingezetene.nietingezetenewoonlockadbuitadrwoonplaats,\n    "
+"              nietingezetene.nietingezetenewoonlockadbuitadrregio,nietingezetene.nietingezetenewoonlockadbuitadrland)),'"
+"')) AS adres,\n      NULLIF(concat_ws(' ', perceel.kdoperceelkadaanduidanaamadgemwaarde, perceel.kdoperceelkadaanduidsec"
+"tie, perceel.kdoperceelkadaanduidanaamadgemperceelnummer, perceel.kdoperceelkadaanduidanaamadgemappartsrechtvolgnummer),"
+" '') AS perceel,\n      perceel.kdoperceelkadgroottewaarde AS grootte,\n      perceel.kdoperceelsoortgroottewaarde AS gr"
+"oottesoort,\n      geom.geom AS geo\nFROM brk_nietingezetene nietingezetene\nLEFT JOIN anl_persoon adr ON trim(to_char(a"
+"dr.burgerservicenummer, '999999999')) = nietingezetene.nietingezetenebsn\nLEFT JOIN brk_tennaamstelling tennaamstelling "
+"ON nietingezetene.nietingezeteneid = tennaamstelling.tennaamstellingvanpersoonnietingezetenehref\nLEFT JOIN brk_zakelijk"
+"recht zakelijkrecht ON zakelijkrecht.kdozakelijkrechtid = tennaamstelling.tennaamstellingvanzakelijkrechthref\nLEFT JOIN"
+" brk_zakelijkrecht_belastmet belastmet ON belastmet.href = zakelijkrecht.kdozakelijkrechtid\nLEFT JOIN brk_zakelijkrecht"
+" hoofdrecht ON hoofdrecht.kdozakelijkrechtid = belastmet.zakelijkrechtid\nLEFT JOIN brk_kdoperceel perceel ON perceel.kd"
+"operceelid = zakelijkrecht.kdozakelijkrechtrustophref OR perceel.kdoperceelid = hoofdrecht.kdozakelijkrechtrustophref\nL"
+"EFT JOIN brk_geometry geom ON geom.id = perceel.kdoperceelid;\n\nINSERT INTO brk_perceel_persoon SELECT\n      natprs.ka"
+"dnatprsid AS link_id,\n      null AS bsn,\n      upper(NULLIF(concat_ws(' ', natprs.kadnatprsvoornamen, natprs.kadnatprs"
+"voorvoegselsgeslachtsnaam, natprs.kadnatprsgeslachtsnaam), '')) AS naam,\n      natprs.kadnatprsgeboortedatum AS geboort"
+"edatum,\n      null AS adres,\n      NULLIF(concat_ws(' ', perceel.kdoperceelkadaanduidanaamadgemwaarde, perceel.kdoperc"
+"eelkadaanduidsectie, perceel.kdoperceelkadaanduidanaamadgemperceelnummer, perceel.kdoperceelkadaanduidanaamadgemappartsr"
+"echtvolgnummer), '') AS perceel,\n      perceel.kdoperceelkadgroottewaarde AS grootte,\n      perceel.kdoperceelsoortgro"
+"ottewaarde AS groottesoort,\n      geom.geom AS geo\nFROM brk_kadnatprs natprs\nLEFT JOIN brk_tennaamstelling tennaamste"
+"lling ON natprs.kadnatprsid = tennaamstelling.tennaamstellingvanpersoonkadnatprshref\nLEFT JOIN brk_zakelijkrecht zakeli"
+"jkrecht ON zakelijkrecht.kdozakelijkrechtid = tennaamstelling.tennaamstellingvanzakelijkrechthref\nLEFT JOIN brk_zakelij"
+"krecht_belastmet belastmet ON belastmet.href = zakelijkrecht.kdozakelijkrechtid\nLEFT JOIN brk_zakelijkrecht hoofdrecht "
+"ON hoofdrecht.kdozakelijkrechtid = belastmet.zakelijkrechtid\nLEFT JOIN brk_kdoperceel perceel ON perceel.kdoperceelid ="
+" zakelijkrecht.kdozakelijkrechtrustophref OR perceel.kdoperceelid = hoofdrecht.kdozakelijkrechtrustophref\nLEFT JOIN brk"
+"_geometry geom ON geom.id = perceel.kdoperceelid;\n\nALTER TABLE brk_perceel_persoon\n  OWNER TO " + Settings.get("CONNECTION_DEFINITION", "user") + ";\nGRANT ALL ON TABLE brk_perceel_persoon TO " + Settings.get("CONNECTION_DEFINITION", "user") + ";\n\nCOMMENT ON TABLE brk_perceel_persoon IS 'Report persoon';\nCOMMENT ON COLUMN brk_perceel_persoon.bsn IS 'BSN';\nCO"
+"MMENT ON COLUMN brk_perceel_persoon.naam IS 'Naam';\nCOMMENT ON COLUMN brk_perceel_persoon.geboortedatum IS 'Geboortedat"
+"um';\nCOMMENT ON COLUMN brk_perceel_persoon.adres IS 'Adres';\nCOMMENT ON COLUMN brk_perceel_persoon.perceel IS 'Perceel"
+"-id';\nCOMMENT ON COLUMN brk_perceel_persoon.geo IS 'Geo object';";
...
context.result = true;
context.jobName = "brk_perceel_persoon_job";
 ...
 */
    ...
    public static void main(String[] args){
        final perceel_personen perceel_personenClass = new perceel_personen();

        int exitCode = perceel_personenClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = perceel_personen.class.getClassLoader().getResourceAsStream("brk/perceel_personen_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = perceel_personen.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : perceel_personen");
        }
...
/************************************************************************************************
 *     82772 characters generated by Talend Open Studio for Data Integration 
