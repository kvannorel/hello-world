...
package brk.extractinitialfile_0_1;
...
/**
 * Job: extractInitialFile Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status 
 */
public class extractInitialFile implements TalendJob {
...
public String getConfDir(){
	...
	private final String jobName = "extractInitialFile";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				extractInitialFile.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(extractInitialFile.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tXSLT_1_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public void tFileUnarchive_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tFileUnarchive_1";
        ...
        String zipFileURL_tFileUnarchive_1 = Settings.get("BRK_PATH") + "brk_init.zip";
        String tmpFileURL_tFileUnarchive_1 = zipFileURL_tFileUnarchive_1.toLowerCase();
        String outputPath_tFileUnarchive_1 = Settings.get("BRK_PATH") + "TempBRK/";
	...
	final String decryptedPassword_tFileUnarchive_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[3wsOMnbk/woqdy5ZsU6GMg==]");
        ...
        unzip_tFileUnarchive_1.setUseZip4jDecryption(false);
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
			...
			int NB_ITERATE_tXSLT_1 = 0; //for statistics
  ...
  String directory_tFileList_1 = Settings.get("BRK_PATH") + "TempBRK/";
 ...
 */
	NB_ITERATE_tXSLT_1++;
				...
				if(execStat){
					runStat.updateStatOnConnection("iterate1", 1, "exec" + NB_ITERATE_tXSLT_1);
					//Thread.sleep(1000);
				}				
 ...
 */
	...
	java.io.File xsltFiletXSLT_1 = new java.io.File(context.confDir+"brk_init_zn.xsl");
	javax.xml.transform.stream.StreamSource styleSourcetXSLT_1 = new javax.xml.transform.stream.StreamSource(xsltFiletXSLT_1);
	javax.xml.transform.Transformer ttXSLT_1 = javax.xml.transform.TransformerFactory.newInstance(net.sf.saxon.TransformerFactoryImpl.class.getName(), null).newTransformer(styleSourcetXSLT_1);

	

	javax.xml.transform.stream.StreamSource xmlSourcetXSLT_1 = new javax.xml.transform.stream.StreamSource(new java.io.File((String)globalMap.get("tFileList_1_CURRENT_FILEPATH")));
	ttXSLT_1.transform(xmlSourcetXSLT_1, new javax.xml.transform.stream.StreamResult(new java.io.File(context.xmlLocation)));
		
	if((context.xmlLocation).indexOf("/") != -1)
	{
		globalMap.put("tXSLT_1_OUTPUT_FILEPATH", (context.xmlLocation).substring(0,(context.xmlLocation).lastIndexOf("/")));
		globalMap.put("tXSLT_1_OUTPUT_FILENAME", (context.xmlLocation).substring((context.xmlLocation).lastIndexOf("/") + 1));
	}
	else
	{
		globalMap.put("tXSLT_1_OUTPUT_FILEPATH", context.xmlLocation);
		globalMap.put("tXSLT_1_OUTPUT_FILENAME", context.xmlLocation);	
	}					
 ...
 */
	...
	/**
	 * [tXSLT_1 process_data_begin ] start
	 */
...
/**
 * [tXSLT_1 process_data_begin ] stop
 */
	
	/**
	 * [tXSLT_1 process_data_end ] start
	 */
 ...
 */
						if(execStat){
							runStat.updateStatOnConnection("iterate1", 2, "exec" + NB_ITERATE_tXSLT_1);
						}				
 ...
 */
	...
	currentComponent="tFileCopy_1";
        ...
        String srcFileName_tFileCopy_1 = Settings.get("BRK_PATH") + "brk_init.zip";
        ...
        String desDirName_tFileCopy_1 = Settings.get("BRK_PATH") + "BRK_Archive/";

		String desFileName_tFileCopy_1 =  "brk_init_"  + TalendDate.getDate("CCYY-MM-DD") + ".zip" ;
		...
		if (!srcFile_tFileCopy_1.getPath().equals(desFile_tFileCopy_1.getPath())  && !desFile_tFileCopy_1.exists()  ) {
				...
				java.io.File isRemoved_tFileCopy_1 = new java.io.File(Settings.get("BRK_PATH") + "brk_init.zip");
 ...
 */
    ...
    public static void main(String[] args){
        final extractInitialFile extractInitialFileClass = new extractInitialFile();

        int exitCode = extractInitialFileClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = extractInitialFile.class.getClassLoader().getResourceAsStream("brk/extractinitialfile_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = extractInitialFile.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : extractInitialFile");
        }
...
/************************************************************************************************
 *     55420 characters generated by Talend Open Studio for Data Integration 
