...
package brk.copy_of_extractinitialfile_0_1;
...
/**
 * Job: Copy_of_extractInitialFile Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Copy_of_extractInitialFile implements TalendJob {
	...
	private final String jobName = "Copy_of_extractInitialFile";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Copy_of_extractInitialFile.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_extractInitialFile.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tXSLT_1_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap)
	...
	public void tXSLT_1_onSubJobError(Exception exception, String errorComponent,
	...
	public void tXSLT_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.io.File xsltFiletXSLT_1 = new java.io.File(
						"D:/Makelaarsuite/mks01-nodejs/CirCooNodejs/ldf/conf/brk_init_zn.xsl");
				...
				javax.xml.transform.Transformer ttXSLT_1 = javax.xml.transform.TransformerFactory
						.newInstance(net.sf.saxon.TransformerFactoryImpl.class.getName(), null)
						.newTransformer(styleSourcetXSLT_1);

				javax.xml.transform.stream.StreamSource xmlSourcetXSLT_1 = new javax.xml.transform.stream.StreamSource(
						new java.io.File("C:/Users/norel00/Documents/Mijn eigen documenten/BRK/StandMetadataData.xml"));
				ttXSLT_1.transform(xmlSourcetXSLT_1, new javax.xml.transform.stream.StreamResult(new java.io.File(
						"C:/Users/norel00/Documents/Mijn eigen documenten/BRK/StandMetadataData_zn.xml")));

				if (("C:/Users/norel00/Documents/Mijn eigen documenten/BRK/StandMetadataData_zn.xml")
						.indexOf("/") != -1) {
					globalMap.put("tXSLT_1_OUTPUT_FILEPATH",
							("C:/Users/norel00/Documents/Mijn eigen documenten/BRK/StandMetadataData_zn.xml").substring(
									0, ("C:/Users/norel00/Documents/Mijn eigen documenten/BRK/StandMetadataData_zn.xml")
											.lastIndexOf("/")));
	...
	public static void main(String[] args) {
		final Copy_of_extractInitialFile Copy_of_extractInitialFileClass = new Copy_of_extractInitialFile();

		int exitCode = Copy_of_extractInitialFileClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_extractInitialFile.class.getClassLoader()
					.getResourceAsStream("brk/copy_of_extractinitialfile_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Copy_of_extractInitialFile.class.getClassLoader()
		...
		} catch (TalendException e_tXSLT_1) {
			globalMap.put("tXSLT_1_SUBPROCESS_STATE", -1);

			e_tXSLT_1.printStackTrace();
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Copy_of_extractInitialFile");
		}
...
/************************************************************************************************
 * 29126 characters generated by Talend Open Studio for Data Integration on the
 * 7 mei 2020 12:12:08 CEST
 ************************************************************************************************/