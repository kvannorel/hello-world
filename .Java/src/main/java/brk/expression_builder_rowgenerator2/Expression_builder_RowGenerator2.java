...
package brk.expression_builder_rowgenerator2;
...
public class Expression_builder_RowGenerator2 implements TalendJob {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_BRK_Expression_builder_RowGenerator2 = new byte[0];
		static byte[] commonByteArray_BRK_Expression_builder_RowGenerator2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_BRK_Expression_builder_RowGenerator2.length) {
					if (length < 1024 && commonByteArray_BRK_Expression_builder_RowGenerator2.length == 0) {
						commonByteArray_BRK_Expression_builder_RowGenerator2 = new byte[1024];
					} else {
						commonByteArray_BRK_Expression_builder_RowGenerator2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_BRK_Expression_builder_RowGenerator2, 0, length);
				strReturn = new String(commonByteArray_BRK_Expression_builder_RowGenerator2, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_BRK_Expression_builder_RowGenerator2) {
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Expression_builder_RowGenerator2.class.getClassLoader()
					.getResourceAsStream("brk/expression_builder_rowgenerator2/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 30463 characters generated by Talend Open Studio for Data Integration on the
 * 6 mei 2020 16:41:25 CEST
 ************************************************************************************************/