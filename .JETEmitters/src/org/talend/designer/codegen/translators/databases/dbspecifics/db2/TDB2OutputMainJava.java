...
public class TDB2OutputMainJava {
  ...
  protected final String TEXT_228 = NL + "\t\t\t\tString update_";
  protected final String TEXT_229 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_230 = " + \"\\\" SET ";
  protected final String TEXT_231 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_232 = "+\" WHERE ";
  protected final String TEXT_233 = "\";";
  protected final String TEXT_234 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_235 = ".prepareStatement(update_";
  protected final String TEXT_236 = NL + "\t    pstmt_";
  protected final String TEXT_237 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_238 = " + \"\\\" WHERE ";
  protected final String TEXT_239 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_240 = ");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_241 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_242 = "\", pstmtInsert_";
  protected final String TEXT_243 = ");" + NL + "\t    pstmtUpdate_";
  protected final String TEXT_244 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_245 = "\", pstmtUpdate_";
  protected final String TEXT_246 = NL + "\t    pstmtUpdate_";
  protected final String TEXT_247 = NL + "\t    String delete_";
  protected final String TEXT_248 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_253 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_254 = " = insert_";
  protected final String TEXT_255 = ".split(\"\\\\?\");";
  protected final String TEXT_256 = NL + "\t\t\tupdate_";
  protected final String TEXT_257 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_258 = " = update_";
  protected final String TEXT_259 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_260 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_261 = NL + "\t\t\tdelete_";
  protected final String TEXT_262 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_263 = " = delete_";
  protected final String TEXT_264 = NL + "\t\t\treplace_";
  protected final String TEXT_265 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_266 = " = replace_";
  protected final String TEXT_267 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_268 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_269 = " = insertIgnore_";
  protected final String TEXT_270 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_271 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_272 = " = buffersSize_";
  protected final String TEXT_273 = ";";
  protected final String TEXT_274 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_275 = NL + "        whetherReject_";
  protected final String TEXT_276 = " = false;";
  protected final String TEXT_277 = NL + "\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_278 = ".setInsert_";
  protected final String TEXT_279 = ",pstmt_";
  protected final String TEXT_280 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_281 = ",query_";
  protected final String TEXT_282 = ",insertSQLSplits_";
  protected final String TEXT_283 = NL + "\t\t\t\t\t);";
  protected final String TEXT_284 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_285 = ",";
  protected final String TEXT_286 = ", ";
  protected final String TEXT_287 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_288 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_296 = ".addBatch();" + NL + "        \t\tnb_line_";
  protected final String TEXT_297 = "++;" + NL + "    \t\t  \t";
  protected final String TEXT_298 = NL + "\t\t  \t\t\tbatchSizeCounter_";
  protected final String TEXT_299 = "++;" + NL + "    \t\t";
  protected final String TEXT_300 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_301 = "++;" + NL + "                insertedCount_";
  ...
  protected final String TEXT_305 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_310 = NL + "                        \t\tdataPropagateUtil_";
  protected final String TEXT_311 = ".assign_";
  protected final String TEXT_312 = "_";
  protected final String TEXT_313 = ");" + NL + "                        \t\t";
  protected final String TEXT_314 = NL + "                        \t\t";
  protected final String TEXT_315 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_316 = NL + "                        rejectedCount_";
  protected final String TEXT_317 = " = rejectedCount_";
  protected final String TEXT_318 = " + 1;";
  protected final String TEXT_319 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_320 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_321 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_322 = NL + "            }";
  protected final String TEXT_323 = ".setUpdate_";
  protected final String TEXT_324 = ",updateSQLSplits_";
  protected final String TEXT_325 = NL + "        \t        ";
  protected final String TEXT_326 = NL + "            \t    ";
  protected final String TEXT_327 = NL + "                    \t";
  protected final String TEXT_328 = ";" + NL + "                    \t";
  protected final String TEXT_329 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_330 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_331 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_338 = NL + "    \t\t  \t\tbatchSizeCounter_";
  protected final String TEXT_339 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_340 = " = updatedCount_";
  protected final String TEXT_341 = NL + NL + "            int checkCount_";
  protected final String TEXT_342 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_343 = " = pstmt_";
  protected final String TEXT_344 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_345 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_346 = " = rs_";
  protected final String TEXT_347 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_348 = " > 0) {" + NL + "    \t\t\t";
  protected final String TEXT_349 = NL + "\t\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_350 = ",pstmtUpdate_";
  protected final String TEXT_351 = NL + "\t\t\t\t\t\t);";
  protected final String TEXT_352 = NL + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_353 = ", pstmtUpdate_";
  protected final String TEXT_354 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_355 = NL + "\t\t\t\t";
  protected final String TEXT_356 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_357 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_358 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_359 = NL + "                    globalMap.put(\"";
  protected final String TEXT_360 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_361 = " + pstmtUpdate_";
  protected final String TEXT_362 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_363 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_364 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_365 = NL + "                        throw(e);";
  protected final String TEXT_366 = NL + "                    \tnb_line_";
  protected final String TEXT_367 = "++;" + NL + "                    \t";
  protected final String TEXT_368 = NL + "                            \t\tdataPropagateUtil_";
  protected final String TEXT_369 = ");" + NL + "                            \t\t";
  protected final String TEXT_370 = NL + "                            \t\t";
  protected final String TEXT_371 = ";" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_372 = NL + "                            rejectedCount_";
  protected final String TEXT_373 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_374 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_375 = ",pstmtInsert_";
  protected final String TEXT_376 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_377 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_378 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_379 = ", pstmtInsert_";
  protected final String TEXT_380 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_381 = " + pstmtInsert_";
  protected final String TEXT_382 = "++;";
  protected final String TEXT_383 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\t";
  protected final String TEXT_384 = NL + "    \t    int updateFlag_";
  protected final String TEXT_385 = "=0;" + NL + "    \t    ";
  protected final String TEXT_386 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_387 = NL + "    \t\t\t\t\t";
  protected final String TEXT_388 = ";" + NL + "\t\t\t\t\t";
  protected final String TEXT_389 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_390 = "=pstmtUpdate_";
  protected final String TEXT_391 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_392 = " + updateFlag_";
  protected final String TEXT_393 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_394 = " == 0) {" + NL + "            \t";
  protected final String TEXT_395 = NL + "\t\t\t\tquery_";
  protected final String TEXT_396 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_397 = ");" + NL + "\t                \t\t\t";
  protected final String TEXT_398 = NL + "                    insertedCount_";
  protected final String TEXT_399 = ".executeUpdate();" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_400 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_401 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_402 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_409 = NL + "            try {" + NL + "            \tdeletedCount_";
  protected final String TEXT_410 = " = deletedCount_";
  protected final String TEXT_411 = ".executeUpdate();" + NL + "            \tnb_line_";
  protected final String TEXT_412 = NL + "                \tnb_line_";
  protected final String TEXT_413 = "++;" + NL + "                \t";
  protected final String TEXT_414 = NL + "                            \tdataPropagateUtil_";
  protected final String TEXT_415 = ");" + NL + "                            \t";
  protected final String TEXT_416 = NL + "                            \t";
  protected final String TEXT_417 = NL + "    \t";
  protected final String TEXT_418 = NL + "            if(!whetherReject_";
  protected final String TEXT_419 = ") {";
  protected final String TEXT_420 = NL + "                                \tdataPropagateUtil_";
  protected final String TEXT_421 = ");" + NL + "                                \t";
  protected final String TEXT_422 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_423 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_424 = " > 0) && (batchSize_";
  protected final String TEXT_425 = " <= batchSizeCounter_";
  protected final String TEXT_426 = ")) {" + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_427 = " = 0;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_428 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_429 = ": pstmt_";
  protected final String TEXT_430 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_431 = " == java.sql.Statement.SUCCESS_NO_INFO ){" + NL + "        \t\t\t\t\t\tcountSum_";
  protected final String TEXT_432 = " += 1;" + NL + "        \t\t\t\t\t}else{" + NL + "        \t\t\t\t\t\tcountSum_";
  protected final String TEXT_433 = " += (countEach_";
  protected final String TEXT_434 = " < 0 ? 0 : countEach_";
  protected final String TEXT_435 = ");" + NL + "        \t\t\t\t\t}" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_441 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_442 = NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_443 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_444 = "){" + NL + "    \t\t\tjava.sql.SQLException ne_";
  protected final String TEXT_445 = " = e_";
  protected final String TEXT_446 = ".getNextException(),sqle_";
  protected final String TEXT_447 = "=null;" + NL + "    \t\t\tString errormessage_";
  protected final String TEXT_448 = ";" + NL + "\t\t\t\tif (ne_";
  protected final String TEXT_449 = " != null) {" + NL + "\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\tsqle_";
  protected final String TEXT_450 = " = new java.sql.SQLException(e_";
  protected final String TEXT_451 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_452 = ".getMessage(), ne_";
  protected final String TEXT_453 = ".getSQLState(), ne_";
  protected final String TEXT_454 = ".getErrorCode(), ne_";
  protected final String TEXT_455 = ");" + NL + "\t\t\t\t\terrormessage_";
  protected final String TEXT_456 = " = sqle_";
  protected final String TEXT_457 = ".getMessage();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\terrormessage_";
  protected final String TEXT_458 = ".getMessage();" + NL + "\t\t\t\t}" + NL + "\t\t\t\t" + NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_459 = NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_460 = " != null) {" + NL + "\t\t\t\t\t\tthrow(sqle_";
  protected final String TEXT_461 = ");" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tthrow(e_";
  protected final String TEXT_462 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_463 = NL + "\t\t\t\tSystem.err.println(errormessage_";
  protected final String TEXT_464 = ");" + NL + "\t\t\t\tint countSum_";
  protected final String TEXT_465 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_466 = ": e_";
  protected final String TEXT_467 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\tif(countEach_";
  protected final String TEXT_468 = " == java.sql.Statement.SUCCESS_NO_INFO ){" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_469 = " += 1;" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_470 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_471 = NL + "\t\t\t\t\tinsertedCount_";
  protected final String TEXT_472 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_473 = NL + "\t\t\t\t\tupdatedCount_";
  protected final String TEXT_474 = NL + "\t\t\t\t\tdeletedCount_";
  protected final String TEXT_475 = NL + "\t\t\t\t}" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_476 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_477 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_478 = " <= commitCounter_";
  protected final String TEXT_479 = NL + "                if ((batchSize_";
  protected final String TEXT_480 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_481 = " > 0)) {" + NL + "                try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_482 = " = 0;" + NL + "                \t\tint countSum_";
  protected final String TEXT_483 = " = 0;" + NL + "                \t\t";
  protected final String TEXT_484 = NL + "                }catch (java.sql.BatchUpdateException e_";
  ...
  protected final String TEXT_489 = NL + "                \tcommitCounter_";
  protected final String TEXT_490 = "=0;" + NL + "                }";
