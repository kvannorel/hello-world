...
public class TPostgresqlRowEndJava
{
  ...
  protected final String TEXT_55 = NL + "        stmt_";
  protected final String TEXT_56 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_57 = " +\" OFF\");" + NL + "\t";
  protected final String TEXT_58 = NL + "\t";
  protected final String TEXT_59 = NL + "        pstmt_";
  protected final String TEXT_60 = ".close();" + NL + "        resourceMap.remove(\"pstmt_";
  protected final String TEXT_61 = "\");";
  protected final String TEXT_62 = NL + "        stmt_";
  protected final String TEXT_63 = ".close();" + NL + "        resourceMap.remove(\"stmt_";
  protected final String TEXT_64 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_65 = "\", true);";
  protected final String TEXT_66 = NL + "\t\tif(commitEvery_";
  protected final String TEXT_67 = ">commitCounter_";
  protected final String TEXT_68 = "){" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_69 = NL + "\t" + NL + "\t\t\tcommitCounter_";
