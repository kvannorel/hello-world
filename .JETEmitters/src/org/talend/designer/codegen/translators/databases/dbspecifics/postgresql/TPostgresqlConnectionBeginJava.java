...
public class TPostgresqlConnectionBeginJava
{
  ...
  protected final String TEXT_35 = NL + "        java.util.Enumeration<java.sql.Driver> drivers_";
  protected final String TEXT_36 = " =  java.sql.DriverManager.getDrivers();" + NL + "        java.util.Set<String> redShiftDriverNames_";
  protected final String TEXT_37 = " = new java.util.HashSet<String>(java.util.Arrays" + NL + "                .asList(\"com.amazon.redshift.jdbc.Driver\",\"com.amazon.redshift.jdbc41.Driver\",\"com.amazon.redshift.jdbc42.Driver\"));" + NL + "    while (drivers_";
  protected final String TEXT_38 = ".hasMoreElements()) {" + NL + "        java.sql.Driver d_";
  protected final String TEXT_39 = " = drivers_";
  protected final String TEXT_40 = ".nextElement();" + NL + "        if (redShiftDriverNames_";
  protected final String TEXT_41 = ".contains(d_";
  protected final String TEXT_42 = ".getClass().getName())) {" + NL + "            try {" + NL + "                java.sql.DriverManager.deregisterDriver(d_";
  protected final String TEXT_43 = ");" + NL + "                java.sql.DriverManager.registerDriver(d_";
  protected final String TEXT_44 = ");" + NL + "            } catch (java.lang.Exception e_";
  protected final String TEXT_45 = ") {" + NL + "                    //do nothing" + NL + "            }" + NL + "        }" + NL + "    }";
  ...
  protected final String TEXT_84 = " - Uses an existing connection. Connection URL: \" + conn_";
  ...
  protected final String TEXT_92 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_93 = ".commit();" + NL + "\t\t\t";
  ...
  protected final String TEXT_117 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_118 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_119 = ".get(dsAlias_";
  protected final String TEXT_120 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_121 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_122 = " = dataSources_";
  protected final String TEXT_123 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_124 = ");" + NL + "\t}";
  protected final String TEXT_125 = NL + "\tif (null != conn_";
  protected final String TEXT_126 = ") {" + NL + "\t\t";
  protected final String TEXT_127 = NL + "\t}";
  protected final String TEXT_128 = NL + NL + "\tglobalMap.put(\"schema_\" + \"";
