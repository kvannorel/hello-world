...
public class TPostgresPlusOutputBeginJava {
  ...
  protected final String TEXT_68 = ";" + NL + "       int batchSizeCounter_";
  protected final String TEXT_69 = "=0;" + NL + "       int tmp_batchUpdateCount_";
  ...
  protected final String TEXT_75 = NL + "    java.lang.Class.forName(\"org.postgresql.Driver\");";
  protected final String TEXT_76 = NL + "        String url_";
  protected final String TEXT_77 = " = \"jdbc:postgresql://\"+";
  ...
  protected final String TEXT_94 = NL + "\tresourceMap.put(\"conn_";
  ...
  protected final String TEXT_99 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_100 = NL + "            try (java.sql.Statement stmtDrop_";
  protected final String TEXT_101 = " = conn_";
  protected final String TEXT_102 = ".createStatement();" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_110 = NL + "            try (java.sql.Statement stmtCreate_";
  protected final String TEXT_111 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_112 = ".getMetaData();" + NL + "            boolean whetherExist_";
  protected final String TEXT_113 = " = false;" + NL + "            String defaultSchema_";
  protected final String TEXT_114 = " = \"public\";" + NL + "            try (java.sql.ResultSet rsTable_";
  protected final String TEXT_115 = " = dbMetaData_";
  protected final String TEXT_116 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                if(dbschema_";
  protected final String TEXT_117 = ".trim().length() == 0) {" + NL + "                    try (java.sql.Statement stmtSchema_";
  protected final String TEXT_118 = ".createStatement();" + NL + "                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_119 = " = stmtSchema_";
  protected final String TEXT_120 = ".executeQuery(\"select current_schema() \")) {" + NL + "                        while(rsSchema_";
  protected final String TEXT_121 = ".next()){" + NL + "                            defaultSchema_";
  protected final String TEXT_122 = " = rsSchema_";
  protected final String TEXT_123 = ".getString(\"current_schema\");" + NL + "                        }" + NL + "                    }" + NL + "                }" + NL + "                while(rsTable_";
  ...
  protected final String TEXT_130 = ".equals(dbschema_";
  protected final String TEXT_131 = ") || ((dbschema_";
  protected final String TEXT_132 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_133 = ".equals(schema_";
  ...
  protected final String TEXT_146 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_147 = NL + "                deletedCount_";
  protected final String TEXT_148 = " = deletedCount_";
  protected final String TEXT_149 = " + stmtClear_";
  protected final String TEXT_150 = ".executeUpdate(\"";
  protected final String TEXT_151 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_156 = NL + "                stmtTrunc_";
  ...
  protected final String TEXT_160 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_166 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_177 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_182 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_183 = "\", pstmtInsert_";
  ...
  protected final String TEXT_186 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_187 = "\", pstmtUpdate_";
  protected final String TEXT_188 = NL + "\t    String delete_";
  protected final String TEXT_189 = " = \"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_190 = ".prepareStatement(delete_";
  protected final String TEXT_191 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_196 = NL + "\t\t\tupdate_";
  protected final String TEXT_197 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_198 = " = update_";
  protected final String TEXT_199 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_200 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_201 = NL + "\t\t\tdelete_";
  protected final String TEXT_202 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_203 = " = delete_";
  protected final String TEXT_204 = NL + "\t\t\treplace_";
  protected final String TEXT_205 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_206 = " = replace_";
