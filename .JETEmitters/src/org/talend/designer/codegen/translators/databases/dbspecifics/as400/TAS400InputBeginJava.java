...
public class TAS400InputBeginJava
{
  ...
  protected final String TEXT_132 = " = \"jdbc:as400://\" + ";
  ...
  protected final String TEXT_138 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_139 = NL + "\t\t        conn_";
  protected final String TEXT_140 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_141 = "\");";
  protected final String TEXT_142 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_143 = " =  conn_";
  protected final String TEXT_144 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_145 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_146 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_147 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_148 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_149 = NL + "                 conn_";
  protected final String TEXT_150 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_151 = NL + "               ";
  protected final String TEXT_152 = " + \"=\" + ";
  protected final String TEXT_153 = " + \";\" +";
  protected final String TEXT_154 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_155 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_156 = NL + "\t\t    ";
  protected final String TEXT_157 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_158 = ";" + NL + "\t\t\t";
  protected final String TEXT_159 = NL + "                log.debug(\"";
  protected final String TEXT_160 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_161 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_162 = NL;
  protected final String TEXT_163 = NL + "            \tglobalMap.put(\"";
  protected final String TEXT_164 = "_QUERY\",dbquery_";
  protected final String TEXT_165 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_166 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  protected final String TEXT_167 = " = stmt_";
  protected final String TEXT_168 = ".executeQuery(dbquery_";
  ...
  protected final String TEXT_172 = ".getColumnCount();" + NL;
  protected final String TEXT_173 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_174 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_175 = ".setDbmsId(\"";
  protected final String TEXT_176 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_177 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_178 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_179 = ".add(\"";
  protected final String TEXT_180 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_181 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_182 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_183 = "; i <= rsmd_";
  protected final String TEXT_184 = ".getColumnCount()-";
  protected final String TEXT_185 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_186 = ".contains(rsmd_";
  protected final String TEXT_187 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_188 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_189 = ".setName(rsmd_";
  protected final String TEXT_190 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_200 = ".setDbTypeId(rsmd_";
  protected final String TEXT_201 = ".getColumnType(i));";
  protected final String TEXT_202 = NL + "                \tdcm_";
  protected final String TEXT_203 = ".setFormat(";
  ...
  protected final String TEXT_211 = ".getPrecision(i));";
  protected final String TEXT_212 = ".setPrecision(rsmd_";
  protected final String TEXT_213 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_214 = ".setNullable(rsmd_";
  protected final String TEXT_215 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_216 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_217 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_218 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_219 = ".metadatas.add(dcm_";
  protected final String TEXT_220 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_221 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_222 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_223 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_224 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_225 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_226 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_227 = NL + "\t\t    while (rs_";
  protected final String TEXT_228 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_229 = "++;" + NL + "\t\t        ";
  protected final String TEXT_230 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_231 = " + dcg_";
  protected final String TEXT_232 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_233 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_234 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_235 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_245 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_246 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_247 = NL + "                                    ";
  protected final String TEXT_248 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_254 = ".setEPSG(";
  protected final String TEXT_255 = ");" + NL + "                                        }";
  protected final String TEXT_256 = NL + "                                  ";
  protected final String TEXT_257 = "=dcg_";
  protected final String TEXT_258 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_259 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_260 = "; i_";
  protected final String TEXT_261 = "  <= rsmd_";
  protected final String TEXT_262 = ".getColumnCount(); i_";
  ...
  protected final String TEXT_275 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_276 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_277 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_278 = ".add(rs_";
  protected final String TEXT_279 = ".getString(i_";
  protected final String TEXT_280 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_281 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_282 = ", rs_";
  protected final String TEXT_283 = ", fixedColumnCount_";
  protected final String TEXT_284 = ",list_";
  protected final String TEXT_285 = ",";
  protected final String TEXT_286 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_287 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_288 = NL + "                                  Object geom = rs_";
  protected final String TEXT_289 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_290 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_291 = " = null;" + NL + "                                  }";
  protected final String TEXT_292 = NL + "\t\t                          ";
  protected final String TEXT_293 = NL + "\t\t                    }";
  protected final String TEXT_294 = NL + "\t\t\t\t\t";
  protected final String TEXT_295 = " - Retrieving the record \" + nb_line_";
