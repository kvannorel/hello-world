...
public class TPostgresqlRowFinallyJava
{
  ...
  protected final String TEXT_56 = NL + "    if (resourceMap.get(\"statementClosed_";
  protected final String TEXT_57 = "\") == null) {";
  protected final String TEXT_58 = NL + "            java.sql.PreparedStatement pstmtToClose_";
  protected final String TEXT_59 = " = null;" + NL + "            if ((pstmtToClose_";
  protected final String TEXT_60 = " = (java.sql.PreparedStatement) resourceMap.remove(\"pstmt_";
  protected final String TEXT_61 = "\")) != null) {" + NL + "                pstmtToClose_";
  protected final String TEXT_62 = ".close();" + NL + "            }";
  protected final String TEXT_63 = NL + "            java.sql.Statement stmtToClose_";
  protected final String TEXT_64 = " = null;" + NL + "            if ((stmtToClose_";
  protected final String TEXT_65 = " = (java.sql.Statement) resourceMap.remove(\"stmt_";
  protected final String TEXT_66 = "\")) != null) {" + NL + "                stmtToClose_";
  protected final String TEXT_67 = NL + "    }";
  protected final String TEXT_68 = NL + "} finally {" + NL + "        if(resourceMap.get(\"finish_";
  protected final String TEXT_69 = "\") == null){" + NL + "            java.sql.Connection ctn_";
  protected final String TEXT_70 = " = null;" + NL + "            if((ctn_";
  protected final String TEXT_71 = " = (java.sql.Connection)resourceMap.get(\"conn_";
  protected final String TEXT_72 = "\")) != null){" + NL + "                try {";
  protected final String TEXT_73 = NL + "                    ctn_";
  protected final String TEXT_74 = ".close();";
  protected final String TEXT_75 = NL + "                } catch (java.sql.SQLException sqlEx_";
  protected final String TEXT_76 = ") {" + NL + "                    String errorMessage_";
  protected final String TEXT_77 = " = \"failed to close the connection in ";
  protected final String TEXT_78 = " :\" + sqlEx_";
  protected final String TEXT_79 = ".getMessage();";
  protected final String TEXT_80 = NL + "                    System.err.println(errorMessage_";
