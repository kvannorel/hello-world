...
public class TPostgresqlRowBeginJava
{
  ...
  protected final String TEXT_55 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_56 = " = \"";
  protected final String TEXT_57 = "\";" + NL + "\t\t    java.lang.Class jdbcclazz_";
  protected final String TEXT_58 = " = java.lang.Class.forName(driverClass_";
  protected final String TEXT_59 = ");" + NL + "\t\t";
  protected final String TEXT_60 = ",dbUser_";
  protected final String TEXT_61 = ",dbPwd_";
  protected final String TEXT_62 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_63 = NL + "\t\t            java.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_64 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t            if (null != dataSources_";
  protected final String TEXT_65 = ") {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_66 = NL + "            \t\t\tString dsAlias_";
  ...
  protected final String TEXT_73 = ").getConnection();" + NL + "\t\t            } else {" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_89 = ".getAutoCommit()) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_90 = NL + "\t\t\t\t\t}        " + NL + "\t\t\t\t\tint commitEvery_";
  protected final String TEXT_91 = ";" + NL + "\t\t\t\t\tint commitCounter_";
  ...
  protected final String TEXT_101 = " = null;" + NL + "\tString query_";
  ...
  protected final String TEXT_108 = ".prepareStatement(";
  protected final String TEXT_109 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_110 = "\", pstmt_";
  protected final String TEXT_111 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_112 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
