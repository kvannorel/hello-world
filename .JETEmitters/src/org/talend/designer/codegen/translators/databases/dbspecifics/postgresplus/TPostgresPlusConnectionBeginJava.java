...
public class TPostgresPlusConnectionBeginJava
{
  ...
  protected final String TEXT_26 = " = \"jdbc:postgresql://\"+";
  protected final String TEXT_27 = "+\":\"+";
  protected final String TEXT_28 = "+\"/\"+";
  protected final String TEXT_29 = ";" + NL + "" + NL + "            if(dbProperties_";
  protected final String TEXT_30 = " != null && !\"\".equals(dbProperties_";
  protected final String TEXT_31 = ".trim())) {" + NL + "                url_";
  protected final String TEXT_32 = " = url_";
  protected final String TEXT_33 = " + \"?\" + dbProperties_";
  protected final String TEXT_34 = ";" + NL + "            }";
  protected final String TEXT_35 = NL + NL + "\t";
  protected final String TEXT_36 = NL + "\t\tString dbUser_";
  ...
  protected final String TEXT_51 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_56 = " - Written records count: \" + nb_line_";
  protected final String TEXT_57 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_58 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_59 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_60 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_61 = " - Writing the record \" + nb_line_";
  protected final String TEXT_62 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_63 = " - Processing the record \" + nb_line_";
  protected final String TEXT_64 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_65 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_66 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_67 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_68 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_69 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_70 = " - Uses an existing connection ";
  protected final String TEXT_71 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_72 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_73 = " - Uses an existing connection. Connection URL: \" + conn_";
  protected final String TEXT_74 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_75 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_76 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_77 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_78 = ", dbUser_";
  protected final String TEXT_79 = ", dbPwd_";
  protected final String TEXT_80 = ");" + NL + "\t\t\t";
  protected final String TEXT_81 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_82 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_83 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_84 = NL + "\t\t\t\tlog.";
  ...
  protected final String TEXT_91 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_92 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_93 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_94 = ": pstmt_";
  protected final String TEXT_95 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_96 = " += (countEach_";
  protected final String TEXT_97 = " < 0 ? 0 : ";
  ...
  protected final String TEXT_101 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  protected final String TEXT_102 = " == null) {";
  protected final String TEXT_103 = NL + "\t\t";
  protected final String TEXT_104 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_105 = "\", conn_";
  protected final String TEXT_106 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_107 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_108 = ".get(dsAlias_";
  protected final String TEXT_109 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_110 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_111 = " = dataSources_";
  protected final String TEXT_112 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_113 = ");" + NL + "\t}";
  protected final String TEXT_114 = NL + "\tif (null != conn_";
  protected final String TEXT_115 = ") {" + NL + "\t\t";
  protected final String TEXT_116 = NL + "\t}";
  protected final String TEXT_117 = NL + NL + "\tglobalMap.put(\"schema_\" + \"";
