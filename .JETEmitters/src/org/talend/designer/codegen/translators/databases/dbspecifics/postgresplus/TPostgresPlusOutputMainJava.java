...
public class TPostgresPlusOutputMainJava {
  ...
  protected final String TEXT_65 = NL + "                                   rejectedCount_";
  ...
  protected final String TEXT_70 = NL + "                                   System.err.print(e.getMessage());";
  ...
  protected final String TEXT_77 = NL + "            int checkCount_";
  protected final String TEXT_78 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_79 = " = pstmt_";
  protected final String TEXT_80 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_81 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_82 = " = rs_";
  protected final String TEXT_83 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_91 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_92 = " + pstmtUpdate_";
  protected final String TEXT_93 = ".executeUpdate();" + NL + "                    nb_line_";
  ...
  protected final String TEXT_101 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_102 = " + pstmtInsert_";
  protected final String TEXT_103 = "++;" + NL + "\t\t\t\t\t";
  protected final String TEXT_104 = NL + "                    \t\tnb_line_";
  protected final String TEXT_105 = "++;" + NL + "                    \t";
  protected final String TEXT_106 = NL + "                }" + NL + "            }";
  protected final String TEXT_107 = NL + "            int updateFlag_";
  protected final String TEXT_108 = "=0;";
  protected final String TEXT_109 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_110 = "=pstmtUpdate_";
  protected final String TEXT_111 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_112 = "+updateFlag_";
  protected final String TEXT_113 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_114 = " == 0) {" + NL + "            \t";
  protected final String TEXT_115 = NL + "\t\t\t\tquery_";
  protected final String TEXT_116 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_117 = NL + "                    insertedCount_";
  protected final String TEXT_118 = NL + "             }else{" + NL + "             \t   nb_line_";
  protected final String TEXT_119 = "++;" + NL + "             \t   ";
  protected final String TEXT_120 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_121 = NL + "                           nb_line_";
  protected final String TEXT_122 = NL + "                }";
  protected final String TEXT_123 = NL + "                       try {" + NL + "                           deletedCount_";
  protected final String TEXT_124 = " = deletedCount_";
  protected final String TEXT_125 = NL + "                               nb_line_";
  protected final String TEXT_126 = NL + "            if(!whetherReject_";
  protected final String TEXT_127 = ") {";
  protected final String TEXT_128 = NL + "            }";
  protected final String TEXT_129 = NL + "                if ((batchSize_";
  protected final String TEXT_130 = " > 0) && (batchSize_";
  protected final String TEXT_131 = " <= batchSizeCounter_";
  protected final String TEXT_132 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_133 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_134 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_135 = " = 0;";
  protected final String TEXT_136 = NL + "                        status_";
  protected final String TEXT_137 = ".executeBatch();";
  protected final String TEXT_138 = NL + "                        for(int countEach_";
  protected final String TEXT_139 = ": status_";
  protected final String TEXT_140 = ") {" + NL + "                            countSum_";
  protected final String TEXT_141 = " += (countEach_";
  protected final String TEXT_142 = " < 0 ? 0 : countEach_";
  protected final String TEXT_143 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_144 = NL + "                            throw(e);";
  protected final String TEXT_145 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_146 = ");" + NL + "                        }";
  protected final String TEXT_147 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_148 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_149 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_150 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_151 = " = tmp_batchUpdateCount_";
  protected final String TEXT_152 = " > countSum_";
  protected final String TEXT_153 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_154 = " : countSum_";
  protected final String TEXT_155 = NL + "                        insertedCount_";
  protected final String TEXT_156 = " += tmp_batchUpdateCount_";
  protected final String TEXT_157 = NL + "                        updatedCount_";
  protected final String TEXT_158 = NL + "                        deletedCount_";
  protected final String TEXT_159 = NL + "               }";
  protected final String TEXT_160 = NL + "                commitCounter_";
  protected final String TEXT_161 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_162 = " <= commitCounter_";
  protected final String TEXT_163 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_164 = " > 0) {" + NL + "\t                    int countSum_";
  protected final String TEXT_165 = " = 0;" + NL + "\t                    ";
  protected final String TEXT_166 = NL + "\t                    for(int countEach_";
  protected final String TEXT_167 = ": pstmt_";
  protected final String TEXT_168 = ".executeBatch()) {" + NL + "\t                        countSum_";
  protected final String TEXT_169 = ");" + NL + "\t                    }" + NL + "\t                    ";
  protected final String TEXT_170 = NL + "\t                        insertedCount_";
  protected final String TEXT_171 = " += countSum_";
  protected final String TEXT_172 = ";" + NL + "\t                    ";
  protected final String TEXT_173 = NL + "\t                        updatedCount_";
  protected final String TEXT_174 = NL + "\t                        deletedCount_";
  protected final String TEXT_175 = NL + "\t                    batchSizeCounter_";
  protected final String TEXT_176 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_177 = NL + "                        int countSum_";
  protected final String TEXT_178 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_179 = NL + "                            insertedCount_";
  protected final String TEXT_180 = NL + "                            updatedCount_";
  protected final String TEXT_181 = NL + "                            deletedCount_";
  protected final String TEXT_182 = NL + "                conn_";
  protected final String TEXT_183 = ".commit();";
