...
public class ComponentBegin
{
  ...
  protected final String TEXT_128 = NL + NL + "org.talend.components.api.component.ComponentDefinition def_";
  protected final String TEXT_129 = " =" + NL + "        new ";
  protected final String TEXT_130 = "();";
  protected final String TEXT_131 = NL;
  protected final String TEXT_132 = " props_";
  protected final String TEXT_133 = " =" + NL + "        (";
  protected final String TEXT_134 = ") def_";
  protected final String TEXT_135 = ".createRuntimeProperties();";
  protected final String TEXT_136 = NL + "    if (org.talend.components.api.properties.ComponentReferenceProperties.ReferenceType.COMPONENT_INSTANCE == props_";
  protected final String TEXT_137 = ".referenceType.getValue()) {" + NL + "        final String referencedComponentInstanceId_";
  protected final String TEXT_138 = " = props_";
  protected final String TEXT_139 = ".componentInstanceId.getStringValue();" + NL + "        if (referencedComponentInstanceId_";
  protected final String TEXT_140 = " != null) {" + NL + "            org.talend.daikon.properties.Properties referencedComponentProperties_";
  protected final String TEXT_141 = " = (org.talend.daikon.properties.Properties) globalMap.get(" + NL + "                referencedComponentInstanceId_";
  protected final String TEXT_142 = " + \"_COMPONENT_RUNTIME_PROPERTIES\");" + NL + "            props_";
  protected final String TEXT_143 = ".setReference(referencedComponentProperties_";
  protected final String TEXT_144 = ");" + NL + "        }" + NL + "    }";
  protected final String TEXT_145 = NL + "globalMap.put(\"";
  protected final String TEXT_146 = "_COMPONENT_RUNTIME_PROPERTIES\", props_";
  protected final String TEXT_147 = ");" + NL + "globalMap.putIfAbsent(\"TALEND_PRODUCT_VERSION\", \"";
  protected final String TEXT_148 = "\");" + NL + "globalMap.put(\"TALEND_COMPONENTS_VERSION\", \"";
  protected final String TEXT_149 = "\");";
  protected final String TEXT_150 = NL + "final String buffersSizeKey_";
  protected final String TEXT_151 = " = \"buffersSizeKey_";
  protected final String TEXT_152 = "_\" + Thread.currentThread().getId(); ";
  protected final String TEXT_153 = NL + "java.net.URL mappings_url_";
  protected final String TEXT_154 = "= this.getClass().getResource(\"/xmlMappings\");" + NL + "globalMap.put(\"";
  protected final String TEXT_155 = "_MAPPINGS_URL\", mappings_url_";
  protected final String TEXT_156 = ");" + NL + "" + NL + "org.talend.components.api.container.RuntimeContainer container_";
  protected final String TEXT_157 = " = new org.talend.components.api.container.RuntimeContainer() {" + NL + "    public Object getComponentData(String componentId, String key) {" + NL + "        return globalMap.get(componentId + \"_\" + key);" + NL + "    }" + NL + "" + NL + "    public void setComponentData(String componentId, String key, Object data) {" + NL + "        globalMap.put(componentId + \"_\" + key, data);" + NL + "    }" + NL + "" + NL + "    public String getCurrentComponentId() {" + NL + "        return \"";
  protected final String TEXT_158 = "\";" + NL + "    }" + NL + "" + NL + "    public Object getGlobalData(String key) {" + NL + "    \treturn globalMap.get(key);" + NL + "    }" + NL + "};" + NL + "" + NL + "int nb_line_";
  protected final String TEXT_159 = " = 0;" + NL + "" + NL + "org.talend.components.api.component.ConnectorTopology topology_";
  protected final String TEXT_160 = NL + "topology_";
  protected final String TEXT_161 = " = org.talend.components.api.component.ConnectorTopology.INCOMING_AND_OUTGOING;";
  protected final String TEXT_162 = " = org.talend.components.api.component.ConnectorTopology.INCOMING;";
  protected final String TEXT_163 = " = org.talend.components.api.component.ConnectorTopology.OUTGOING;";
  protected final String TEXT_164 = " = org.talend.components.api.component.ConnectorTopology.NONE;";
  protected final String TEXT_165 = NL + NL + "org.talend.daikon.runtime.RuntimeInfo runtime_info_";
  protected final String TEXT_166 = " = def_";
  protected final String TEXT_167 = ".getRuntimeInfo(" + NL + "    org.talend.components.api.component.runtime.ExecutionEngine.DI, props_";
  protected final String TEXT_168 = ", topology_";
  protected final String TEXT_169 = ");" + NL + "java.util.Set<org.talend.components.api.component.ConnectorTopology> supported_connector_topologies_";
  protected final String TEXT_170 = ".getSupportedConnectorTopologies();" + NL + "" + NL + "org.talend.components.api.component.runtime.RuntimableRuntime componentRuntime_";
  protected final String TEXT_171 = " = (org.talend.components.api.component.runtime.RuntimableRuntime)(Class.forName(runtime_info_";
  protected final String TEXT_172 = ".getRuntimeClassName()).newInstance());" + NL + "org.talend.daikon.properties.ValidationResult initVr_";
  protected final String TEXT_173 = " = componentRuntime_";
  protected final String TEXT_174 = ".initialize(container_";
  protected final String TEXT_175 = ", props_";
  protected final String TEXT_176 = ");" + NL + "" + NL + "if (initVr_";
  protected final String TEXT_177 = ".getStatus() == org.talend.daikon.properties.ValidationResult.Result.ERROR ) {" + NL + "    throw new RuntimeException(initVr_";
  protected final String TEXT_178 = ".getMessage());" + NL + "}" + NL + "" + NL + "if(componentRuntime_";
  protected final String TEXT_179 = " instanceof org.talend.components.api.component.runtime.ComponentDriverInitialization) {" + NL + "\torg.talend.components.api.component.runtime.ComponentDriverInitialization compDriverInitialization_";
  protected final String TEXT_180 = " = (org.talend.components.api.component.runtime.ComponentDriverInitialization)componentRuntime_";
  protected final String TEXT_181 = ";" + NL + "\tcompDriverInitialization_";
  protected final String TEXT_182 = ".runAtDriver(container_";
  protected final String TEXT_183 = ");" + NL + "}" + NL + "" + NL + "org.talend.components.api.component.runtime.SourceOrSink sourceOrSink_";
  protected final String TEXT_184 = " = null;" + NL + "if(componentRuntime_";
  protected final String TEXT_185 = " instanceof org.talend.components.api.component.runtime.SourceOrSink) {" + NL + "\tsourceOrSink_";
  protected final String TEXT_186 = " = (org.talend.components.api.component.runtime.SourceOrSink)componentRuntime_";
  protected final String TEXT_187 = ";" + NL + "\torg.talend.daikon.properties.ValidationResult vr_";
  protected final String TEXT_188 = " = sourceOrSink_";
  protected final String TEXT_189 = ".validate(container_";
  protected final String TEXT_190 = ");" + NL + "\tif (vr_";
  protected final String TEXT_191 = ".getStatus() == org.talend.daikon.properties.ValidationResult.Result.ERROR ) {" + NL + "    \tthrow new RuntimeException(vr_";
  protected final String TEXT_192 = ".getMessage());" + NL + "\t}" + NL + "}" + NL;
  protected final String TEXT_193 = NL + "    org.talend.components.api.component.runtime.Source source_";
  protected final String TEXT_194 = " =" + NL + "            (org.talend.components.api.component.runtime.Source)sourceOrSink_";
  protected final String TEXT_195 = ";" + NL + "    org.talend.components.api.component.runtime.Reader reader_";
  protected final String TEXT_196 = " =" + NL + "            source_";
  protected final String TEXT_197 = ".createReader(container_";
  protected final String TEXT_198 = ");" + NL + "\treader_";
  protected final String TEXT_199 = " = new org.talend.codegen.flowvariables.runtime.FlowVariablesReader(reader_";
  protected final String TEXT_200 = ", container_";
  protected final String TEXT_201 = ");" + NL;
  protected final String TEXT_202 = NL + "        boolean multi_output_is_allowed_";
  protected final String TEXT_203 = " = false;";
  protected final String TEXT_204 = NL + "        org.talend.components.api.component.Connector c_";
  protected final String TEXT_205 = " = null;" + NL + "        for (org.talend.components.api.component.Connector currentConnector : props_";
  protected final String TEXT_206 = ".getAvailableConnectors(null, true)) {" + NL + "            if (currentConnector.getName().equals(\"";
  protected final String TEXT_207 = "\")) {" + NL + "                c_";
  protected final String TEXT_208 = " = currentConnector;" + NL + "            }" + NL + "" + NL + "            if (currentConnector.getName().equals(\"REJECT\")) {//it's better to move the code to javajet" + NL + "                multi_output_is_allowed_";
  protected final String TEXT_209 = " = true;" + NL + "            }" + NL + "        }" + NL + "        org.apache.avro.Schema schema_";
  ...
  protected final String TEXT_218 = ".advance()) {" + NL + "    \tnb_line_";
  protected final String TEXT_219 = "++;" + NL + "" + NL + "    \t";
  protected final String TEXT_220 = NL + "        if (multi_output_is_allowed_";
  protected final String TEXT_221 = ") {";
  protected final String TEXT_222 = NL + "        }";
  protected final String TEXT_223 = NL + NL + "        try {" + NL + "            Object data_";
  protected final String TEXT_224 = ".getCurrent();";
  protected final String TEXT_225 = NL + NL + "                if(multi_output_is_allowed_";
  protected final String TEXT_226 = " = new ";
  protected final String TEXT_227 = "Struct();" + NL + "                }" + NL;
  protected final String TEXT_228 = NL + "        } catch (org.talend.components.api.exception.DataRejectException e_";
  protected final String TEXT_229 = ") {" + NL + "        \tjava.util.Map<String,Object> info_";
  protected final String TEXT_230 = " = e_";
  protected final String TEXT_231 = ".getRejectInfo();";
  protected final String TEXT_232 = NL + "                Object data_";
  protected final String TEXT_233 = " = info_";
  protected final String TEXT_234 = ".get(\"talend_record\");" + NL + "" + NL + "                if (multi_output_is_allowed_";
  protected final String TEXT_235 = "Struct();" + NL + "                }" + NL + "\t\t\t\ttry{";
  protected final String TEXT_236 = NL + "                }catch(java.lang.Exception e){" + NL + "                \t// do nothing" + NL + "                }";
  protected final String TEXT_237 = ")info_";
  protected final String TEXT_238 = ".get(\"";
  protected final String TEXT_239 = NL + "            \t//TODO use a method instead of getting method by the special key \"error/errorMessage\"" + NL + "            \tObject errorMessage_";
  protected final String TEXT_240 = " = null;" + NL + "            \tif(info_";
  protected final String TEXT_241 = ".containsKey(\"error\")){" + NL + "            \t\terrorMessage_";
  protected final String TEXT_242 = ".get(\"error\");" + NL + "        \t\t}else if(info_";
  protected final String TEXT_243 = ".containsKey(\"errorMessage\")){" + NL + "            \t\terrorMessage_";
  protected final String TEXT_244 = ".get(\"errorMessage\");" + NL + "        \t\t}else{" + NL + "        \t\t\terrorMessage_";
  protected final String TEXT_245 = " = \"Rejected but error message missing\";" + NL + "        \t\t}" + NL + "        \t\terrorMessage_";
  protected final String TEXT_246 = " = \"Row \"+ nb_line_";
  protected final String TEXT_247 = " + \": \"+errorMessage_";
  protected final String TEXT_248 = ";" + NL + "    \t\t\tSystem.err.println(errorMessage_";
  protected final String TEXT_249 = NL + "            \t// If the record is reject, the main line record should put NULL" + NL + "            \t";
  protected final String TEXT_250 = NL + "    }";
  protected final String TEXT_251 = NL + "    org.talend.components.api.component.runtime.Sink sink_";
  protected final String TEXT_252 = " =" + NL + "            (org.talend.components.api.component.runtime.Sink)sourceOrSink_";
  protected final String TEXT_253 = ";" + NL + "    org.talend.components.api.component.runtime.WriteOperation writeOperation_";
  protected final String TEXT_254 = " = sink_";
  protected final String TEXT_255 = ".createWriteOperation();" + NL + "    writeOperation_";
  protected final String TEXT_256 = ");" + NL + "    org.talend.components.api.component.runtime.Writer writer_";
  protected final String TEXT_257 = " = writeOperation_";
  protected final String TEXT_258 = ".createWriter(container_";
  protected final String TEXT_259 = ");" + NL + "    writer_";
  protected final String TEXT_260 = ".open(\"";
  protected final String TEXT_261 = "\");" + NL + "" + NL + "    resourceMap.put(\"writer_";
  protected final String TEXT_262 = "\", writer_";
  protected final String TEXT_263 = ");" + NL + "" + NL + "    org.talend.components.api.component.Connector c_";
  protected final String TEXT_264 = " = null;" + NL + "    for (org.talend.components.api.component.Connector currentConnector : props_";
  protected final String TEXT_265 = ".getAvailableConnectors(null, false)) {" + NL + "        if (currentConnector.getName().equals(\"MAIN\")) {" + NL + "            c_";
  protected final String TEXT_266 = " = currentConnector;" + NL + "            break;" + NL + "        }" + NL + "    }" + NL + "    org.apache.avro.Schema designSchema_";
  protected final String TEXT_267 = ", false);" + NL + "    org.talend.codegen.enforcer.IncomingSchemaEnforcer incomingEnforcer_";
  protected final String TEXT_268 = NL + "            = new org.talend.codegen.enforcer.IncomingSchemaEnforcer(designSchema_";
  protected final String TEXT_269 = NL + "                c_";
  protected final String TEXT_270 = " = null;" + NL + "                for (org.talend.components.api.component.Connector currentConnector : props_";
  protected final String TEXT_271 = ".getAvailableConnectors(null, true)) {" + NL + "                    if (currentConnector.getName().equals(\"MAIN\")) {" + NL + "                        c_";
  protected final String TEXT_272 = " = currentConnector;" + NL + "                    }" + NL + "                }" + NL + "                org.apache.avro.Schema mainSchema_";
  protected final String TEXT_273 = ", true);";
  protected final String TEXT_274 = ".getAvailableConnectors(null, true)) {" + NL + "                    if (currentConnector.getName().equals(\"REJECT\")) {" + NL + "                        c_";
  protected final String TEXT_275 = " = currentConnector;" + NL + "                    }" + NL + "                }" + NL + "                org.apache.avro.Schema rejectSchema_";
  protected final String TEXT_276 = NL + "                java.lang.Iterable<?> outgoingMainRecordsList_";
  protected final String TEXT_277 = " = new java.util.ArrayList<Object>();" + NL + "                java.util.Iterator outgoingMainRecordsIt_";
